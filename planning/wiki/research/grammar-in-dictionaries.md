...
5. **Example-based grammar teaching**: With over 104,500 examples averaging 4.0 per entry, the dictionary provides substantial implicit grammar input through examples.
