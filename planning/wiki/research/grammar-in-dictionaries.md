...
5. **Example-based grammar teaching**: With over 104,000 examples averaging 4.0 per entry, the dictionary provides substantial implicit grammar input through examples.
