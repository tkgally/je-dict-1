...
je-dict-1 does not have a formal CDV because its glosses are **English translations**, not English paraphrases. What it has instead is a **three-tier vocabulary classification** (basic 801, core 1,982, general 22,390) that plays a structurally similar role in two ways:
