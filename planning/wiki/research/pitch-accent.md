...
1. **Data sourcing** — There is no freely available, comprehensive pitch accent database in a format suitable for bulk integration. OJAD covers a subset of vocabulary. The NHK and Shinmeikai dictionaries are copyrighted. Manual annotation of 19,000+ entries is impractical.
