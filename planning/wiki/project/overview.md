...
je-dict-1 is a Japanese-English learner's dictionary hosted as a static website at [tkgje.jp](https://www.tkgje.jp/). It targets intermediate learners of Japanese — people who can read kana and are actively building vocabulary. As of June 2026, it contains over 28,400 entries with over 112,300 example sentences and over 16,200 cross-references.
...
- **General** (25,000+ entries, growing) — everything else. All new entries go here. There is no maximum size for the dictionary. (Current count: ~25,682.)
