...
je-dict-1 is a Japanese-English learner's dictionary hosted as a static website at [tkgje.jp](https://www.tkgje.jp/). It targets intermediate learners of Japanese — people who can read kana and are actively building vocabulary. As of May 2026, it contains over 27,400 entries with over 109,200 example sentences and 15,700+ cross-references.
...
- **General** (24,700+ entries, growing) — everything else. All new entries go here. There is no maximum size for the dictionary.
