...
je-dict-1 is a Japanese-English learner's dictionary hosted as a static website at [tkgje.jp](https://www.tkgje.jp/). It targets intermediate learners of Japanese — people who can read kana and are actively building vocabulary. As of mid-April 2026, it contains over 23,600 entries with more than 95,700 example sentences and 7,400+ cross-references.
...
- **General** (20,800+ entries, growing) — everything else. All new entries go here. There is no maximum size for the dictionary.
