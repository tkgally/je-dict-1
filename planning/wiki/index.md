...
**Last updated**: 2026-06-26 (wiki: harvest 12 observations from the 2026-06-25 accuracy-review/tooling-fix/new-entries runs + 2026-06-26 polish → Cleanup Backlog P20 [daily-life/errands cohort into 9741–9814 (20%) + new shopping/tech cohort 9815–9849 (60%), both migrated; **enforce-side ratchet shipped** — off-vocab `--check-no-new-unknown` baseline now a CI step], P21 [zero-inline-link band reaches 06271–06281 mimetic/idiom/拝〜-keigo cohort, recommend ~06275–06600 sweep]; **Tooling item 30 RESOLVED** [strand-sweep + CI-gate via MCP; latent `get_status`→`get_check_runs` rescue bug fixed], **item 27 PARTIAL** [inflow gate shipped as the baseline ratchet], item 21 [sixth furigana-screen truncation → ≤~100 IDs], item 20 [sixteenth priority-lane no-op]; Entry Follow-ups [29452 猿人 reading **RESOLVED** さるじん→えんじん + file renamed; new 書き替える C22065 fold into 08225]; Activity A [overview tier counts → 26,496/29,279]; **Activity H not due** [7 new metrics lines < 10])
