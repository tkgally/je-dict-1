...
4. **"What's missing?" prompts**: Occasionally ask an LLM directly, "Given a dictionary of 23,000 Japanese entries for intermediate learners, what common everyday words might still be missing?" — without providing the actual wordlist. The LLM can brainstorm based on its knowledge of what intermediate learners need
