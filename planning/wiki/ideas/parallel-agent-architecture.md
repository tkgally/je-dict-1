...
- **Throughput ceiling**: Only one task runs at a time. With ~25,000 entries and many polishing dimensions, sequential processing will take months to cover everything once.
