...
- **Throughput ceiling**: Only one task runs at a time. With ~24,000 entries and many polishing dimensions, sequential processing will take months to cover everything once.
