...
je-dict-1's LLM-primary workflow has produced over 23,400 entries with consistent quality. The LLM's implicit distributional knowledge, combined with structured prompts, schema validation, and human oversight, has proven effective for:
