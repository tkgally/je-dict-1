...
From the 2026-04-09 plan's target table, compared against `make report` on 2026-05-14 (27,398 entries):

| Metric | Plan target | 2026-05-14 | Notes |
|--------|-------------|------------|-------|
...
| Cross-reference symmetry | 98% | ~40% | 7,742 asymmetric directed refs; largest remaining gap |
...
| Examples per entry (avg) | ≥ 4 | 4.0 | Target reached; **108,947 total examples** |
