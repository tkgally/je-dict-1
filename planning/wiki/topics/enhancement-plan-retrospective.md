...
From the 2026-04-09 plan's target table, compared against `make report` on 2026-06-08 (28,769 entries):

| Metric | Plan target | 2026-06-08 | Notes |
|--------|-------------|------------|-------|
...
| Cross-reference symmetry | 98% | ~41.2% | 7,822 asymmetric directed refs; largest remaining gap |
...
| Examples per entry (avg) | ≥ 4 | 3.9 | Near target; **~113,326 total examples** |
