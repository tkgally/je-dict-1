...
From the 2026-04-09 plan's target table, compared against `make report` on 2026-05-27 (28,035 entries):

| Metric | Plan target | 2026-05-27 | Notes |
|--------|-------------|------------|-------|
| Verbs with transitivity | 100% | ~32% | ~4,734 verbs still missing; transitivity queue slowly progressing |
| Entries with note score ≥ 60 | 80% | ~84% | Target reached |
| Cross-reference symmetry | 98% | ~40.8% | 7,834 asymmetric directed refs; largest remaining gap |
| Verbs with ている docs | 80% (of those needing it) | 17.2% | aspect-notes queue at entry 02317 |
| Multi-model review coverage | 100% (furigana) | 0.4% (queue: ~17,697) | Queue growing as entries outpace review |
| Examples per entry (avg) | ≥ 4 | 4.0 | Target reached; **~110,910 total examples** |
...
Three targets have been met (note quality, examples, cross-reference density). Three are making steady progress (aspect notes, multi-model review, priority polishing throughput). Two remain well below target (transitivity, symmetry) and should drive the next round of work. **Cross-reference density is at 0.58 per entry**, stable as new entries and cross-references grow in proportion. Total cross-references have reached 16,140. Of 18,612 directed references, approximately 40.8% are symmetric — 7,834 asymmetric directed references remain.
