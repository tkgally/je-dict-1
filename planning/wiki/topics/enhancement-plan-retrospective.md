...
From the 2026-04-09 plan's target table, compared against `make report` on 2026-05-15 (27,443 entries):

| Metric | Plan target | 2026-05-15 | Notes |
|--------|-------------|------------|-------|
...
| Cross-reference symmetry | 98% | ~40.5% | 7,745 asymmetric directed refs; largest remaining gap |
| Verbs with ている docs | 80% (of those needing it) | 17.3% | aspect-notes queue at entry 02317 |
| Multi-model review coverage | 100% (furigana) | 0.4% (queue: 13,827) | Queue growing as entries outpace review |
| Examples per entry (avg) | ≥ 4 | 4.0 | Target reached; **109,094 total examples** |
