...
Over 16,100 cross-references exist across 28,100 entries (roughly 0.58 cross-references per entry on average; `report.py` measures the symmetry rate at ~40.8% as of 2026-05-28). Coverage is slowly improving, though new entries continue to add unreciprocated links faster than the symmetry pass processes them. Coverage is growing through:
