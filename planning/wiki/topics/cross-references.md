...
Over 15,600 cross-references exist across 27,300+ entries (roughly 0.57 cross-references per entry on average; `report.py` measures the symmetry rate at ~40.4% as of 2026-05-13). Coverage is slowly improving, though new entries continue to add unreciprocated links faster than the symmetry pass processes them. Coverage is growing through:
