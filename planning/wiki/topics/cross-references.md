...
Over 15,951 cross-references exist across 27,625 entries (roughly 0.58 cross-references per entry on average; `report.py` measures the symmetry rate at ~40.5% as of 2026-05-19). Coverage is slowly improving, though new entries continue to add unreciprocated links faster than the symmetry pass processes them. Coverage is growing through:
