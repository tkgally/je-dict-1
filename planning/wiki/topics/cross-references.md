...
Over 16,000 cross-references exist across 27,836 entries (roughly 0.58 cross-references per entry on average; `report.py` measures the symmetry rate at ~40.6% as of 2026-05-24). Coverage is slowly improving, though new entries continue to add unreciprocated links faster than the symmetry pass processes them. Coverage is growing through:
