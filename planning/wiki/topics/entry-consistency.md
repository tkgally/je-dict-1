...
**Current state**: ~7,400 cross-references across ~23,800 entries, but coverage is uneven. Some semantic clusters are well-linked; others have no cross-references at all.
