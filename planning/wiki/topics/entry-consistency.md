...
**Current state**: ~10,700 cross-references across ~25,300 entries, but coverage is uneven. Some semantic clusters are well-linked; others have no cross-references at all.
