...
**Current state**: ~11,000 cross-references across ~25,500 entries, but coverage is uneven. Some semantic clusters are well-linked; others have no cross-references at all.
