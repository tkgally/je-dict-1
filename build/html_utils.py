...
def generate_nav_header(relative_path: str = '', show_all_links: bool = True) -> str:
    ...
    home_icon = '''<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' width='1em' height='1em' style='vertical-align:-0.15em;margin-right:0.25em;'><circle cx='50' cy='50' r='50' fill='#FFEA00'/><circle cx='50' cy='50' r='30' fill='#FFC107'/><circle cx='42' cy='42' r='8' fill='white' opacity='0.4'/></svg>'''

    # Build navigation links based on show_all_links parameter
    if show_all_links:
        nav_links = f'''
        <a href="{base}index.html" class="nav-link" title="Home" aria-label="Home">{home_icon}</a>
