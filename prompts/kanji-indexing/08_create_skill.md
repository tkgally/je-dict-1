# Kanji Index Implementation - Step 8: Create kanji-index Skill

## Overview

Create a Claude skill that documents the kanji index feature and provides guidance for maintaining it.
...
```bash
mkdir -p .claude/skills/kanji-index
```

### 2. Create `.claude/skills/kanji-index/SKILL.md`
...
1. Verify file exists: `.claude/skills/kanji-index/SKILL.md`
2. Check frontmatter is correct
3. Test that skill appears in Claude Code skill list

## Next Step

Proceed to `09_verification_script.md` to create the kanji index verification script.
