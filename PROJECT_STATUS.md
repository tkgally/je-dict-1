...
Added 25 new dictionary entries (IDs 24404-24428) from candidate_words.json. This batch focuses on common loanwords and practical vocabulary useful for intermediate learners.
...
- **Onomatopoeia (1)**: ごつごつ (rugged/rough)
