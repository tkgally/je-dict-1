...
| Metric | Value |
|--------|-------|
| Total entries | 29,048 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,245 (open — all new entries here) |
| Next entry ID | 29258 |
| Candidate words | 1,318 |
| Cross-references | ~16,400 |
| Example sentences | ~114,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 29258 → `entries/29000/`)
...
- **General** (26,245+): All other vocabulary. All new entries go here.
