...
| Metric | Value |
|--------|-------|
| Total entries | 28,100 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,317 (open — all new entries here) |
| Next entry ID | 28309 |
| Candidate words | 1,622 |
| Cross-references | ~16,100 |
| Example sentences | ~111,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 28309 → `entries/28000/`)
...
- **General** (25,317+): All other vocabulary. All new entries go here.
