...
| Metric | Value |
|--------|-------|
| Total entries | 28,342 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,559 (open — all new entries here) |
| Next entry ID | 28551 |
| Candidate words | 1,580 |
| Cross-references | ~16,200 |
| Example sentences | ~111,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 28551 → `entries/28500/`)
...
- **General** (25,559+): All other vocabulary. All new entries go here.
