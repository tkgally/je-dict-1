...
| Metric | Value |
|--------|-------|
| Total entries | 28,465 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,682 (open — all new entries here) |
| Next entry ID | 28675 |
| Candidate words | 1,511 |
| Cross-references | ~16,200 |
| Example sentences | ~112,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 28675 → `entries/28500/`)
...
- **General** (25,682+): All other vocabulary. All new entries go here.
