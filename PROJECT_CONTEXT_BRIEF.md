...
| Metric | Value |
|--------|-------|
| Total entries | 26,932 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,149 (open — all new entries here) |
| Next entry ID | 27141 |
| Candidate words | 1,723 |
| Cross-references | ~15,000 |
| Example sentences | ~107,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 27141 → `entries/27000/`)
...
- **General** (24,149+): All other vocabulary. All new entries go here.
