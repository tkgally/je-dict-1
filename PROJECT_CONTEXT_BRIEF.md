...
| Metric | Value |
|--------|-------|
| Total entries | 29,371 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,568 (open — all new entries here) |
| Next entry ID | 29581 |
| Candidate words | 1,197 |
| Cross-references | ~16,400 |
| Example sentences | ~115,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 29581 → `entries/29500/`)
...
- **General** (26,568+): All other vocabulary. All new entries go here.
