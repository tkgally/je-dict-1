...
| Metric | Value |
|--------|-------|
| Total entries | 24,306 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,523 (open — all new entries here) |
| Next entry ID | 24509 |
| Candidate words | 2,044 |
| Cross-references | ~8,200 |
| Example sentences | ~98,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 24509 → `entries/24500/`)
...
- **General** (21,523+): All other vocabulary. All new entries go here.
