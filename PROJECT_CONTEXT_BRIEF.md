...
| Metric | Value |
|--------|-------|
| Total entries | 24,613 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,830 (open — all new entries here) |
| Next entry ID | 24816 |
| Candidate words | 1,739 |
| Cross-references | ~8,800 |
| Example sentences | ~99,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 24816 → `entries/24500/`)
...
- **General** (21,830+): All other vocabulary. All new entries go here.
