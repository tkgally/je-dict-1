...
| Metric | Value |
|--------|-------|
| Total entries | 24,432 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,649 (open — all new entries here) |
| Next entry ID | 24635 |
| Candidate words | 1,918 |
| Cross-references | ~8,800 |
| Example sentences | ~98,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 24635 → `entries/24500/`)
...
- **General** (21,649+): All other vocabulary. All new entries go here.
