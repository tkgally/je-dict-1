...
| Metric | Value |
|--------|-------|
| Total entries | 26,383 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,600 (open — all new entries here) |
| Next entry ID | 26591 |
| Candidate words | 1,135 |
| Cross-references | ~13,600 |
| Example sentences | ~105,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 26591 → `entries/26500/`)
...
- **General** (23,600+): All other vocabulary. All new entries go here.
