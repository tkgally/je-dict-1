...
| Metric | Value |
|--------|-------|
| Total entries | 30,244 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,441 (open — all new entries here) |
| Next entry ID | 30454 |
| Candidate words | 990 |
...
- Range = ID rounded down to nearest 500 (e.g., 30454 → `entries/30000/`)
...
- **General** (27,441+): All other vocabulary. All new entries go here.
