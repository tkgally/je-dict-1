...
| Metric | Value |
|--------|-------|
| Total entries | 29,432 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,629 (open — all new entries here) |
| Next entry ID | 29642 |
| Candidate words | 1,176 |
...
- Range = ID rounded down to nearest 500 (e.g., 29642 → `entries/29500/`)
...
- **General** (26,629+): All other vocabulary. All new entries go here.
