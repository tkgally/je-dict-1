...
| Metric | Value |
|--------|-------|
| Total entries | 28,080 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,297 (open — all new entries here) |
| Next entry ID | 28289 |
| Candidate words | 1,624 |
| Cross-references | ~16,100 |
| Example sentences | ~111,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 28289 → `entries/28000/`)
...
- **General** (25,297+): All other vocabulary. All new entries go here.
