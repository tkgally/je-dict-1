...
| Metric | Value |
|--------|-------|
| Total entries | 23,864 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,081 (open — all new entries here) |
| Next entry ID | 24066 |
| Candidate words | 2,490 |
| Cross-references | ~7,600 |
| Example sentences | ~96,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 24066 → `entries/24000/`)
...
- **General** (21,081+): All other vocabulary. All new entries go here.
