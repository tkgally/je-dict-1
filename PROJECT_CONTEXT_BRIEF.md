...
| Metric | Value |
|--------|-------|
| Total entries | 28,035 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,252 (open — all new entries here) |
| Next entry ID | 28244 |
...
- Range = ID rounded down to nearest 500 (e.g., 28244 → `entries/28000/`)
...
- **General** (25,252+): All other vocabulary. All new entries go here.
