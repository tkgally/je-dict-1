...
| Metric | Value |
|--------|-------|
| Total entries | 28,364 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,581 (open — all new entries here) |
| Next entry ID | 28573 |
| Candidate words | 1,570 |
...
- Range = ID rounded down to nearest 500 (e.g., 28573 → `entries/28500/`)
...
- **General** (25,581+): All other vocabulary. All new entries go here.
