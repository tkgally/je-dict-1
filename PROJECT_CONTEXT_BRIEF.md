...
| Metric | Value |
|--------|-------|
| Total entries | 25,123 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,340 (open — all new entries here) |
| Next entry ID | 25331 |
| Candidate words | 2,450 |
| Cross-references | ~10,300 |
| Example sentences | ~101,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 25331 → `entries/25000/`)
...
- **General** (22,340+): All other vocabulary. All new entries go here.
