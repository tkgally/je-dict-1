...
| Metric | Value |
|--------|-------|
| Total entries | 29,973 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,170 (open — all new entries here) |
| Next entry ID | 30183 |
| Candidate words | 1,029 |
| Cross-references | ~16,700 |
| Example sentences | ~117,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 30183 → `entries/30000/`)
...
- **General** (27,170+): All other vocabulary. All new entries go here.
