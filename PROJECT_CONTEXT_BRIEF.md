...
| Metric | Value |
|--------|-------|
| Total entries | 25,458 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,675 (open — all new entries here) |
| Next entry ID | 25666 |
| Candidate words | 2,116 |
...
- Range = ID rounded down to nearest 500 (e.g., 25666 → `entries/25500/`)
...
- **General** (22,675+): All other vocabulary. All new entries go here.
