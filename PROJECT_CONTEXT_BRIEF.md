...
| Metric | Value |
|--------|-------|
| Total entries | 26,524 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,741 (open — all new entries here) |
| Next entry ID | 26732 |
| Candidate words | 991 |
| Cross-references | ~13,900 |
| Example sentences | ~105,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 26732 → `entries/26500/`)
...
- **General** (23,741+): All other vocabulary. All new entries go here.
