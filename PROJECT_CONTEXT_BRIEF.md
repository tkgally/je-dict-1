...
| Metric | Value |
|--------|-------|
| Total entries | 23,021 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,238 (open — all new entries here) |
| Next entry ID | 23223 |
| Candidate words | 3,264 |
| Cross-references | ~5,900 |
| Example sentences | ~93,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 23223 → `entries/23000/`)
...
- **General** (20,238+): All other vocabulary. All new entries go here.
