...
| Metric | Value |
|--------|-------|
| Total entries | 30,284 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,481 (open — all new entries here) |
| Next entry ID | 30494 |
| Candidate words | 994 |
| Cross-references | ~17,800 |
| Example sentences | ~118,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 30494 → `entries/30000/`)
...
- **General** (27,481+): All other vocabulary. All new entries go here.
