...
| Metric | Value |
|--------|-------|
| Total entries | 29,342 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,539 (open — all new entries here) |
| Next entry ID | 29552 |
| Candidate words | 1,220 |
...
- Range = ID rounded down to nearest 500 (e.g., 29552 → `entries/29500/`)
...
- **General** (26,539+): All other vocabulary. All new entries go here.
