...
| Metric | Value |
|--------|-------|
| Total entries | 30,804 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 28,021 (open — all new entries here) |
| Next entry ID | 31014 |
| Candidate words | 164 |
| Cross-references | ~77,600 |
| Example sentences | ~119,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 31014 → `entries/31000/`)
...
- **General** (28,021+): All other vocabulary. All new entries go here.
