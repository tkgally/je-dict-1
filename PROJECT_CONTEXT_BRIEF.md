...
| Metric | Value |
|--------|-------|
| Total entries | 28,300 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,517 (open — all new entries here) |
| Next entry ID | 28509 |
...
- Range = ID rounded down to nearest 500 (e.g., 28509 → `entries/28500/`)
...
- **General** (25,517+): All other vocabulary. All new entries go here.
