...
| Metric | Value |
|--------|-------|
| Total entries | 25,781 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,998 (open — all new entries here) |
| Next entry ID | 25989 |
| Candidate words | 1,798 |
| Cross-references | ~11,600 |
| Example sentences | ~103,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 25989 → `entries/25500/`)
...
- **General** (22,998+): All other vocabulary. All new entries go here.
