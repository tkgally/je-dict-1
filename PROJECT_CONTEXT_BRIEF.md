...
| Metric | Value |
|--------|-------|
| Total entries | 29,058 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,255 (open — all new entries here) |
| Next entry ID | 29268 |
| Candidate words | 1,317 |
| Cross-references | ~16,400 |
| Example sentences | ~114,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 29268 → `entries/29000/`)
...
- **General** (26,255+): All other vocabulary. All new entries go here.
