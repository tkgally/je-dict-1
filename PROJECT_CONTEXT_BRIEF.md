...
| Metric | Value |
|--------|-------|
| Total entries | 25,518 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,735 (open — all new entries here) |
| Next entry ID | 25726 |
| Candidate words | 2,056 |
| Cross-references | ~11,000 |
| Example sentences | ~102,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 25726 → `entries/25500/`)
...
- **General** (22,735+): All other vocabulary. All new entries go here.
