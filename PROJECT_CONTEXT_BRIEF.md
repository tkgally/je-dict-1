...
| Metric | Value |
|--------|-------|
| Total entries | 23,915 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,132 (open — all new entries here) |
| Next entry ID | 24117 |
| Candidate words | 2,440 |
| Cross-references | ~7,700 |
| Example sentences | ~96,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 24117 → `entries/24000/`)
...
- **General** (21,132+): All other vocabulary. All new entries go here.
