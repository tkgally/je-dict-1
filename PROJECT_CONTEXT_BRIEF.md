...
| Metric | Value |
|--------|-------|
| Total entries | 30,167 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,364 (open — all new entries here) |
| Next entry ID | 30377 |
| Candidate words | 994 |
| Cross-references | ~17,400 |
| Example sentences | ~117,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 30377 → `entries/30000/`)
...
- **General** (27,364+): All other vocabulary. All new entries go here.
