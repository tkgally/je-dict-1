...
| Metric | Value |
|--------|-------|
| Total entries | 26,804 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,021 (open — all new entries here) |
| Next entry ID | 27013 |
| Candidate words | 1,893 |
| Cross-references | ~14,700 |
| Example sentences | ~106,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 27013 → `entries/27000/`)
...
- **General** (24,021+): All other vocabulary. All new entries go here.
