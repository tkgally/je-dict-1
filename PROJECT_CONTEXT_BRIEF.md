...
| Metric | Value |
|--------|-------|
| Total entries | 30,484 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,681 (open — all new entries here) |
| Next entry ID | 30694 |
| Candidate words | 163 |
| Cross-references | ~18,600 |
| Example sentences | ~118,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 30694 → `entries/30500/`)
...
- **General** (27,681+): All other vocabulary. All new entries go here.
