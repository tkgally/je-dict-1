...
| Metric | Value |
|--------|-------|
| Total entries | 27,213 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,430 (open — all new entries here) |
| Next entry ID | 27422 |
| Candidate words | 1,643 |
...
- Range = ID rounded down to nearest 500 (e.g., 27422 → `entries/27000/`)
...
- **General** (24,430+): All other vocabulary. All new entries go here.
