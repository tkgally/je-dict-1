...
| Metric | Value |
|--------|-------|
| Total entries | 29,552 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,749 (open — all new entries here) |
| Next entry ID | 29762 |
| Candidate words | 1,167 |
| Cross-references | ~16,500 |
| Example sentences | ~115,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 29762 → `entries/29500/`)
...
- **General** (26,749+): All other vocabulary. All new entries go here.
