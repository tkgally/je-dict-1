...
| Metric | Value |
|--------|-------|
| Total entries | 29,279 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,476 (open — all new entries here) |
| Next entry ID | 29489 |
| Candidate words | 1,222 |
...
- Range = ID rounded down to nearest 500 (e.g., 29489 → `entries/29000/`)
...
- **General** (26,476+): All other vocabulary. All new entries go here.
