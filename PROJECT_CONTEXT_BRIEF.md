...
| Metric | Value |
|--------|-------|
| Total entries | 23,676 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,893 (open — all new entries here) |
| Next entry ID | 23878 |
| Candidate words | 2,680 |
...
- Range = ID rounded down to nearest 500 (e.g., 23878 → `entries/23500/`)
...
- **General** (20,893+): All other vocabulary. All new entries go here.
