...
| Metric | Value |
|--------|-------|
| Total entries | 23,153 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,370 (open — all new entries here) |
| Next entry ID | 23355 |
| Candidate words | 3,133 |
| Cross-references | ~6,300 |
| Example sentences | ~94,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 23355 → `entries/23000/`)
...
- **General** (20,370+): All other vocabulary. All new entries go here.
