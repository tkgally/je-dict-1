...
| Metric | Value |
|--------|-------|
| Total entries | 29,629 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,826 (open — all new entries here) |
| Next entry ID | 29839 |
| Candidate words | 1,146 |
...
- Range = ID rounded down to nearest 500 (e.g., 29839 → `entries/29500/`)
...
- **General** (26,826+): All other vocabulary. All new entries go here.
