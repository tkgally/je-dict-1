...
| Metric | Value |
|--------|-------|
| Total entries | 26,648 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,865 (open — all new entries here) |
| Next entry ID | 26856 |
| Candidate words | 2,096 |
| Cross-references | ~14,200 |
| Example sentences | ~106,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 26856 → `entries/26500/`)
...
- **General** (23,865+): All other vocabulary. All new entries go here.
