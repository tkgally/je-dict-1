...
| Metric | Value |
|--------|-------|
| Total entries | 26,345 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,562 (open — all new entries here) |
| Next entry ID | 26553 |
| Candidate words | 1,221 |
...
- Range = ID rounded down to nearest 500 (e.g., 26553 → `entries/26500/`)
...
- **General** (23,562+): All other vocabulary. All new entries go here.
