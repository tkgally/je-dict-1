...
| Metric | Value |
|--------|-------|
| Total entries | 26,594 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,811 (open — all new entries here) |
| Next entry ID | 26802 |
| Candidate words | 2,150 |
| Cross-references | ~14,200 |
| Example sentences | ~106,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 26802 → `entries/26500/`)
...
- **General** (23,811+): All other vocabulary. All new entries go here.
