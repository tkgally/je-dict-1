...
| Metric | Value |
|--------|-------|
| Total entries | 30,205 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,402 (open — all new entries here) |
| Next entry ID | 30415 |
| Candidate words | 976 |
...
- Range = ID rounded down to nearest 500 (e.g., 30415 → `entries/30000/`)
...
- **General** (27,402+): All other vocabulary. All new entries go here.
