...
| Metric | Value |
|--------|-------|
| Total entries | 23,744 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,961 (open — all new entries here) |
| Next entry ID | 23946 |
| Candidate words | 2,611 |
...
- Range = ID rounded down to nearest 500 (e.g., 23946 → `entries/23500/`)
...
- **General** (20,961+): All other vocabulary. All new entries go here.
