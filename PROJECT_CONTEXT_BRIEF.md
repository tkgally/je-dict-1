...
| Metric | Value |
|--------|-------|
| Total entries | 28,276 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,493 (open — all new entries here) |
| Next entry ID | 28485 |
| Candidate words | 1,539 |
| Cross-references | ~16,200 |
| Example sentences | ~111,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 28485 → `entries/28000/`)
...
- **General** (25,493+): All other vocabulary. All new entries go here.
