...
| Metric | Value |
|--------|-------|
| Total entries | 23,525 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,742 (open — all new entries here) |
| Next entry ID | 23727 |
| Candidate words | 2,831 |
| Cross-references | ~7,400 |
| Example sentences | ~95,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 23727 → `entries/23500/`)
...
- **General** (20,742+): All other vocabulary. All new entries go here.
