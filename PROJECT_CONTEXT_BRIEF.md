...
| Metric | Value |
|--------|-------|
| Total entries | 23,666 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,883 (open — all new entries here) |
| Next entry ID | 23868 |
| Candidate words | 2,690 |
| Cross-references | ~7,400 |
| Example sentences | ~95,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 23868 → `entries/23500/`)
...
- **General** (20,883+): All other vocabulary. All new entries go here.
