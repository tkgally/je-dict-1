...
| Metric | Value |
|--------|-------|
| Total entries | 26,854 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,071 (open — all new entries here) |
| Next entry ID | 27063 |
| Candidate words | 1,820 |
...
- Range = ID rounded down to nearest 500 (e.g., 27063 → `entries/27000/`)
...
- **General** (24,071+): All other vocabulary. All new entries go here.
