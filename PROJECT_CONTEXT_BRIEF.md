...
| Metric | Value |
|--------|-------|
| Total entries | 28,537 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,754 (open — all new entries here) |
| Next entry ID | 28747 |
| Candidate words | 1,545 |
| Cross-references | ~16,200 |
| Example sentences | ~112,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 28747 → `entries/28500/`)
...
- **General** (25,754+): All other vocabulary. All new entries go here.
