...
| Metric | Value |
|--------|-------|
| Total entries | 24,963 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,180 (open — all new entries here) |
| Next entry ID | 25166 |
| Candidate words | 1,375 |
| Cross-references | ~9,800 |
| Example sentences | ~100,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 25166 → `entries/25000/`)
...
- **General** (22,180+): All other vocabulary. All new entries go here.
