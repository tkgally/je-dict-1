...
| Metric | Value |
|--------|-------|
| Total entries | 26,829 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,046 (open — all new entries here) |
| Next entry ID | 27038 |
| Candidate words | 1,846 |
| Cross-references | ~14,700 |
| Example sentences | ~106,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 27038 → `entries/27000/`)
...
- **General** (24,046+): All other vocabulary. All new entries go here.
