...
| Metric | Value |
|--------|-------|
| Total entries | 26,954 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,171 (open — all new entries here) |
| Next entry ID | 27163 |
| Candidate words | 1,701 |
| Cross-references | ~15,000 |
| Example sentences | ~107,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 27163 → `entries/27000/`)
...
- **General** (24,171+): All other vocabulary. All new entries go here.
