...
| Metric | Value |
|--------|-------|
| Total entries | 24,583 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,800 (open — all new entries here) |
| Next entry ID | 24786 |
| Candidate words | 1,769 |
| Cross-references | ~8,800 |
| Example sentences | ~99,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 24786 → `entries/24500/`)
...
- **General** (21,800+): All other vocabulary. All new entries go here.
