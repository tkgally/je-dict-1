...
| Metric | Value |
|--------|-------|
| Total entries | 23,609 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,826 (open — all new entries here) |
| Next entry ID | 23811 |
| Candidate words | 2,747 |
| Cross-references | ~7,400 |
| Example sentences | ~95,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 23811 → `entries/23500/`)
...
- **General** (20,826+): All other vocabulary. All new entries go here.
