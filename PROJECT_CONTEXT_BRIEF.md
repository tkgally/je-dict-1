...
| Metric | Value |
|--------|-------|
| Total entries | 24,908 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,125 (open — all new entries here) |
| Next entry ID | 25111 |
| Candidate words | 1,432 |
| Cross-references | ~9,400 |
| Example sentences | ~100,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 25111 → `entries/25000/`)
...
- **General** (22,125+): All other vocabulary. All new entries go here.
