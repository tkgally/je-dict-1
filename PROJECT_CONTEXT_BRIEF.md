...
| Metric | Value |
|--------|-------|
| Total entries | 30,108 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,305 (open — all new entries here) |
| Next entry ID | 30318 |
| Candidate words | 1,001 |
...
- Range = ID rounded down to nearest 500 (e.g., 30318 → `entries/30000/`)
...
- **General** (27,305+): All other vocabulary. All new entries go here.
