...
| Metric | Value |
|--------|-------|
| Total entries | 27,720 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,937 (open — all new entries here) |
| Next entry ID | 27929 |
| Candidate words | 1,767 |
| Cross-references | ~16,000 |
| Example sentences | ~109,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 27929 → `entries/27500/`)
...
- **General** (24,937+): All other vocabulary. All new entries go here.
