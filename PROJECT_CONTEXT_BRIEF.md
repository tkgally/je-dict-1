...
| Metric | Value |
|--------|-------|
| Total entries | 30,069 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,266 (open — all new entries here) |
| Next entry ID | 30279 |
| Candidate words | 1,015 |
| Cross-references | ~17,000 |
| Example sentences | ~117,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 30279 → `entries/30000/`)
...
- **General** (27,266+): All other vocabulary. All new entries go here.
