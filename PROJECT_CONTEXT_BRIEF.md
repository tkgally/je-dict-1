...
| Metric | Value |
|--------|-------|
| Total entries | 30,302 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,499 (open — all new entries here) |
| Next entry ID | 30512 |
| Candidate words | 983 |
| Cross-references | ~17,900 |
| Example sentences | ~118,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 30512 → `entries/30500/`)
...
- **General** (27,499+): All other vocabulary. All new entries go here.
