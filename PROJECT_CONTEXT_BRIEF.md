...
| Metric | Value |
|--------|-------|
| Total entries | 29,102 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,299 (open — all new entries here) |
| Next entry ID | 29312 |
| Candidate words | 1,298 |
...
- Range = ID rounded down to nearest 500 (e.g., 29312 → `entries/29000/`)
...
- **General** (26,299+): All other vocabulary. All new entries go here.
