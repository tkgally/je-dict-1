...
| Metric | Value |
|--------|-------|
| Total entries | 24,669 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,886 (open — all new entries here) |
| Next entry ID | 24872 |
| Candidate words | 1,676 |
| Cross-references | ~8,800 |
| Example sentences | ~99,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 24872 → `entries/24500/`)
...
- **General** (21,886+): All other vocabulary. All new entries go here.
