...
| Metric | Value |
|--------|-------|
| Total entries | 23,343 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,560 (open — all new entries here) |
| Next entry ID | 23545 |
| Candidate words | 3,012 |
| Cross-references | ~6,300 |
| Example sentences | ~94,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 23545 → `entries/23500/`)
...
- **General** (20,560+): All other vocabulary. All new entries go here.
