...
| Metric | Value |
|--------|-------|
| Total entries | 26,292 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,509 (open — all new entries here) |
| Next entry ID | 26500 |
| Candidate words | 1,277 |
...
- Range = ID rounded down to nearest 500 (e.g., 26500 → `entries/26500/`)
...
- **General** (23,509+): All other vocabulary. All new entries go here.
