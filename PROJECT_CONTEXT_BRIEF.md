...
| Metric | Value |
|--------|-------|
| Total entries | 25,488 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,705 (open — all new entries here) |
| Next entry ID | 25696 |
| Candidate words | 2,086 |
| Cross-references | ~11,000 |
| Example sentences | ~102,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 25696 → `entries/25500/`)
...
- **General** (22,705+): All other vocabulary. All new entries go here.
