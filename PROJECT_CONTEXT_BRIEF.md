...
| Metric | Value |
|--------|-------|
| Total entries | 26,752 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,969 (open — all new entries here) |
| Next entry ID | 26961 |
| Candidate words | 1,951 |
| Cross-references | ~14,700 |
| Example sentences | ~106,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 26961 → `entries/26500/`)
...
- **General** (23,969+): All other vocabulary. All new entries go here.
