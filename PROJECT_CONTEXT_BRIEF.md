...
| Metric | Value |
|--------|-------|
| Total entries | 24,514 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,731 (open — all new entries here) |
| Next entry ID | 24717 |
| Candidate words | 1,839 |
| Cross-references | ~8,800 |
| Example sentences | ~98,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 24717 → `entries/24500/`)
...
- **General** (21,731+): All other vocabulary. All new entries go here.
