...
| Metric | Value |
|--------|-------|
| Total entries | 30,444 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,641 (open — all new entries here) |
| Next entry ID | 30654 |
| Candidate words | 157 |
...
- Range = ID rounded down to nearest 500 (e.g., 30654 → `entries/30500/`)
...
- **General** (27,641+): All other vocabulary. All new entries go here.
