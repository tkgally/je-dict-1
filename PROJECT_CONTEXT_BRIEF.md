...
| Metric | Value |
|--------|-------|
| Total entries | 25,695 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,912 (open — all new entries here) |
| Next entry ID | 25903 |
| Candidate words | 1,887 |
| Cross-references | ~11,600 |
| Example sentences | ~103,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 25903 → `entries/25500/`)
...
- **General** (22,912+): All other vocabulary. All new entries go here.
