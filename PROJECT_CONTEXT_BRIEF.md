...
| Metric | Value |
|--------|-------|
| Total entries | 26,052 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,269 (open — all new entries here) |
| Next entry ID | 26260 |
| Candidate words | 1,520 |
| Cross-references | ~12,600 |
| Example sentences | ~104,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 26260 → `entries/26000/`)
...
- **General** (23,269+): All other vocabulary. All new entries go here.
