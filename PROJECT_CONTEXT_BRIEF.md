...
| Metric | Value |
|--------|-------|
| Total entries | 26,170 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,387 (open — all new entries here) |
| Next entry ID | 26378 |
| Candidate words | 1,399 |
| Cross-references | ~12,900 |
| Example sentences | ~104,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 26378 → `entries/26000/`)
...
- **General** (23,387+): All other vocabulary. All new entries go here.
