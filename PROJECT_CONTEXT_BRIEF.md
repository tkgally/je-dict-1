...
| Metric | Value |
|--------|-------|
| Total entries | 26,544 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,761 (open — all new entries here) |
| Next entry ID | 26752 |
| Candidate words | 970 |
...
- Range = ID rounded down to nearest 500 (e.g., 26752 → `entries/26500/`)
...
- **General** (23,761+): All other vocabulary. All new entries go here.
