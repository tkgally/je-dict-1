...
| Metric | Value |
|--------|-------|
| Total entries | 24,566 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,783 (open — all new entries here) |
| Next entry ID | 24769 |
| Candidate words | 1,787 |
| Cross-references | ~8,800 |
| Example sentences | ~99,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 24769 → `entries/24500/`)
...
- **General** (21,783+): All other vocabulary. All new entries go here.
