...
| Metric | Value |
|--------|-------|
| Total entries | 23,774 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,991 (open — all new entries here) |
| Next entry ID | 23976 |
| Candidate words | 2,581 |
| Cross-references | ~7,400 |
| Example sentences | ~96,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 23976 → `entries/23500/`)
...
- **General** (20,991+): All other vocabulary. All new entries go here.
