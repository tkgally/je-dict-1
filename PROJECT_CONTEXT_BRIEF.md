...
| Metric | Value |
|--------|-------|
| Total entries | 29,839 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,036 (open — all new entries here) |
| Next entry ID | 30049 |
| Candidate words | 1,086 |
...
- Range = ID rounded down to nearest 500 (e.g., 30049 → `entries/30000/`)
...
- **General** (27,036+): All other vocabulary. All new entries go here.
