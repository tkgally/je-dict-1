...
| Metric | Value |
|--------|-------|
| Total entries | 27,625 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,842 (open — all new entries here) |
| Next entry ID | 27834 |
| Candidate words | 1,762 |
| Cross-references | ~15,900 |
| Example sentences | ~109,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 27834 → `entries/27500/`)
...
- **General** (24,842+): All other vocabulary. All new entries go here.
