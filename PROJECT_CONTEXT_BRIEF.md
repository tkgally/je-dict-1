...
| Metric | Value |
|--------|-------|
| Total entries | 29,076 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,273 (open — all new entries here) |
| Next entry ID | 29286 |
| Candidate words | 1,309 |
...
- Range = ID rounded down to nearest 500 (e.g., 29286 → `entries/29000/`)
...
- **General** (26,273+): All other vocabulary. All new entries go here.
