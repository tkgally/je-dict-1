...
| Metric | Value |
|--------|-------|
| Total entries | 23,631 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,848 (open — all new entries here) |
| Next entry ID | 23833 |
| Candidate words | 2,725 |
...
- Range = ID rounded down to nearest 500 (e.g., 23833 → `entries/23500/`)
...
- **General** (20,848+): All other vocabulary. All new entries go here.
