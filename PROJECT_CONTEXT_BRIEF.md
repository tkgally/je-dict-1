...
| Metric | Value |
|--------|-------|
| Total entries | 27,022 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,239 (open — all new entries here) |
| Next entry ID | 27231 |
| Candidate words | 1,660 |
| Cross-references | ~15,100 |
| Example sentences | ~107,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 27231 → `entries/27000/`)
...
- **General** (24,239+): All other vocabulary. All new entries go here.
