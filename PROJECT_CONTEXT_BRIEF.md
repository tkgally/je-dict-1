...
| Metric | Value |
|--------|-------|
| Total entries | 25,917 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,134 (open — all new entries here) |
| Next entry ID | 26125 |
| Candidate words | 1,658 |
| Cross-references | ~12,000 |
| Example sentences | ~103,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 26125 → `entries/26000/`)
...
- **General** (23,134+): All other vocabulary. All new entries go here.
