...
| Metric | Value |
|--------|-------|
| Total entries | 29,955 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,152 (open — all new entries here) |
| Next entry ID | 30165 |
| Candidate words | 1,038 |
| Cross-references | ~16,600 |
| Example sentences | ~116,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 30165 → `entries/30000/`)
...
- **General** (27,152+): All other vocabulary. All new entries go here.
