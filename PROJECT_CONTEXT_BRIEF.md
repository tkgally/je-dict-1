...
| Metric | Value |
|--------|-------|
| Total entries | 29,359 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,556 (open — all new entries here) |
| Next entry ID | 29569 |
...
- Range = ID rounded down to nearest 500 (e.g., 29569 → `entries/29500/`)
...
- **General** (26,556+): All other vocabulary. All new entries go here.
