...
| Metric | Value |
|--------|-------|
| Total entries | 24,541 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,758 (open — all new entries here) |
| Next entry ID | 24744 |
| Candidate words | 1,812 |
...
- Range = ID rounded down to nearest 500 (e.g., 24744 → `entries/24500/`)
...
- **General** (21,758+): All other vocabulary. All new entries go here.
