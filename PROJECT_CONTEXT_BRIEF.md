...
| General tier | 25,800 (open — all new entries here) |
| Next entry ID | 28793 |
...
- Range = ID rounded down to nearest 500 (e.g., 28793 → `entries/28500/`)
...
- **General** (25,800+): All other vocabulary. All new entries go here.
