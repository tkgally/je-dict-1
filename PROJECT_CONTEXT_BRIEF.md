...
| Metric | Value |
|--------|-------|
| Total entries | 23,596 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,813 (open — all new entries here) |
| Next entry ID | 23798 |
| Candidate words | 2,760 |
...
- Range = ID rounded down to nearest 500 (e.g., 23798 → `entries/23500/`)
...
- **General** (20,813+): All other vocabulary. All new entries go here.
