...
| Metric | Value |
|--------|-------|
| Total entries | 24,120 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,337 (open — all new entries here) |
| Next entry ID | 24322 |
| Candidate words | 2,234 |
...
- Range = ID rounded down to nearest 500 (e.g., 24322 → `entries/24000/`)
...
- **General** (21,337+): All other vocabulary. All new entries go here.
