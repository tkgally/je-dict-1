...
| Metric | Value |
|--------|-------|
| Total entries | 29,031 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,228 (open — all new entries here) |
| Next entry ID | 29241 |
| Candidate words | 1,328 |
...
- Range = ID rounded down to nearest 500 (e.g., 29241 → `entries/29000/`)
...
- **General** (26,228+): All other vocabulary. All new entries go here.
