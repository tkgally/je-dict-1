...
| Metric | Value |
|--------|-------|
| Total entries | 27,201 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,418 (open — all new entries here) |
| Next entry ID | 27410 |
...
- Range = ID rounded down to nearest 500 (e.g., 27410 → `entries/27000/`)
...
- **General** (24,418+): All other vocabulary. All new entries go here.
