...
| Metric | Value |
|--------|-------|
| Total entries | 25,093 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,310 (open — all new entries here) |
| Next entry ID | 25301 |
| Candidate words | 2,480 |
| Cross-references | ~10,300 |
| Example sentences | ~100,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 25301 → `entries/25000/`)
...
- **General** (22,310+): All other vocabulary. All new entries go here.
