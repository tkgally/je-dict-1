...
| Metric | Value |
|--------|-------|
| Total entries | 26,307 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,524 (open — all new entries here) |
| Next entry ID | 26515 |
| Candidate words | 1,262 |
| Cross-references | ~13,300 |
| Example sentences | ~105,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 26515 → `entries/26500/`)
...
- **General** (23,524+): All other vocabulary. All new entries go here.
