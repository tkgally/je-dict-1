...
| Metric | Value |
|--------|-------|
| Total entries | 24,356 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,573 (open — all new entries here) |
| Next entry ID | 24559 |
| Candidate words | 1,994 |
| Cross-references | ~8,200 |
| Example sentences | ~98,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 24559 → `entries/24500/`)
...
- **General** (21,573+): All other vocabulary. All new entries go here.
