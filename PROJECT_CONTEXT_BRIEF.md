...
| Metric | Value |
|--------|-------|
| Total entries | 26,618 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,835 (open — all new entries here) |
| Next entry ID | 26826 |
| Candidate words | 2,126 |
| Cross-references | ~14,200 |
| Example sentences | ~106,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 26826 → `entries/26500/`)
...
- **General** (23,835+): All other vocabulary. All new entries go here.
