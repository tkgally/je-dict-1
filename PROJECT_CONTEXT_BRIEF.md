...
| Metric | Value |
|--------|-------|
| Total entries | 24,276 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,493 (open — all new entries here) |
| Next entry ID | 24479 |
| Candidate words | 2,074 |
| Cross-references | ~8,200 |
| Example sentences | ~98,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 24479 → `entries/24000/`)
...
- **General** (21,493+): All other vocabulary. All new entries go here.
