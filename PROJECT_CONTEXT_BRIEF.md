...
| Metric | Value |
|--------|-------|
| Total entries | 26,494 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,711 (open — all new entries here) |
| Next entry ID | 26702 |
| Candidate words | 1,022 |
| Cross-references | ~13,900 |
| Example sentences | ~105,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 26702 → `entries/26500/`)
...
- **General** (23,711+): All other vocabulary. All new entries go here.
