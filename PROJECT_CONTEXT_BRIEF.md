...
| Metric | Value |
|--------|-------|
| Total entries | 23,851 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,068 (open — all new entries here) |
| Next entry ID | 24053 |
| Candidate words | 2,503 |
...
- Range = ID rounded down to nearest 500 (e.g., 24053 → `entries/24000/`)
...
- **General** (21,068+): All other vocabulary. All new entries go here.
