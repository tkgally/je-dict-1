...
| Metric | Value |
|--------|-------|
| Total entries | 30,316 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,513 (open — all new entries here) |
| Next entry ID | 30526 |
| Candidate words | 976 |
...
- Range = ID rounded down to nearest 500 (e.g., 30526 → `entries/30500/`)
...
- **General** (27,513+): All other vocabulary. All new entries go here.
