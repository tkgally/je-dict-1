...
| Metric | Value |
|--------|-------|
| Total entries | 23,041 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,258 (open — all new entries here) |
| Next entry ID | 23243 |
| Candidate words | 3,244 |
| Cross-references | ~6,300 |
| Example sentences | ~93,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 23243 → `entries/23000/`)
...
- **General** (20,258+): All other vocabulary. All new entries go here.
