...
| Metric | Value |
|--------|-------|
| Total entries | 27,264 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,481 (open — all new entries here) |
| Next entry ID | 27473 |
| Candidate words | 1,646 |
| Cross-references | ~15,600 |
| Example sentences | ~108,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 27473 → `entries/27000/`)
...
- **General** (24,481+): All other vocabulary. All new entries go here.
