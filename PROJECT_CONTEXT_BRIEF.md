...
| Metric | Value |
|--------|-------|
| Total entries | 27,673 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,890 (open — all new entries here) |
| Next entry ID | 27882 |
| Candidate words | 1,746 |
| Cross-references | ~15,900 |
| Example sentences | ~109,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 27882 → `entries/27500/`)
...
- **General** (24,890+): All other vocabulary. All new entries go here.
