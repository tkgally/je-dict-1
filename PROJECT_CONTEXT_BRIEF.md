...
| Metric | Value |
|--------|-------|
| Total entries | 29,297 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,494 (open — all new entries here) |
| Next entry ID | 29507 |
| Candidate words | 1,208 |
| Cross-references | ~16,400 |
| Example sentences | ~114,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 29507 → `entries/29500/`)
...
- **General** (26,494+): All other vocabulary. All new entries go here.
