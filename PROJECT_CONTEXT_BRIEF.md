...
| General tier | 27,562 (open — all new entries here) |
| Next entry ID | 30575 |
| Candidate words | 93 |
| Cross-references | ~18,200 |
| Example sentences | ~118,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 30575 → `entries/30500/`)
...
- **General** (27,562+): All other vocabulary. All new entries go here.
