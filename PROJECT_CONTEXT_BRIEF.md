...
| Metric | Value |
|--------|-------|
| Total entries | 29,742 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,939 (open — all new entries here) |
| Next entry ID | 29952 |
...
- Range = ID rounded down to nearest 500 (e.g., 29952 → `entries/29500/`)
...
- **General** (26,939+): All other vocabulary. All new entries go here.
