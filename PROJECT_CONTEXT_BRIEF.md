...
| Metric | Value |
|--------|-------|
| Total entries | 23,059 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,276 (open — all new entries here) |
| Next entry ID | 23261 |
| Candidate words | 3,226 |
...
- Range = ID rounded down to nearest 500 (e.g., 23261 → `entries/23000/`)
...
- **General** (20,276+): All other vocabulary. All new entries go here.
