...
| General tier | 27,602 (open — all new entries here) |
| Next entry ID | 30615 |
| Candidate words | 163 |
...
- Range = ID rounded down to nearest 500 (e.g., 30615 → `entries/30500/`)
...
- **General** (27,602+): All other vocabulary. All new entries go here.
