...
| Metric | Value |
|--------|-------|
| Total entries | 23,811 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,028 (open — all new entries here) |
| Next entry ID | 24013 |
| Candidate words | 2,543 |
...
- Range = ID rounded down to nearest 500 (e.g., 24013 → `entries/24000/`)
...
- **General** (21,028+): All other vocabulary. All new entries go here.
