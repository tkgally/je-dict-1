...
| Metric | Value |
|--------|-------|
| Total entries | 29,269 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,466 (open — all new entries here) |
| Next entry ID | 29479 |
| Candidate words | 1,227 |
...
- Range = ID rounded down to nearest 500 (e.g., 29479 → `entries/29000/`)
...
- **General** (26,466+): All other vocabulary. All new entries go here.
