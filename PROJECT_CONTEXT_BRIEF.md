...
| Metric | Value |
|--------|-------|
| Total entries | 28,791 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,008 (open — all new entries here) |
| Next entry ID | 29001 |
| Candidate words | 1,454 |
...
- Range = ID rounded down to nearest 500 (e.g., 29001 → `entries/29000/`)
...
- **General** (26,008+): All other vocabulary. All new entries go here.
