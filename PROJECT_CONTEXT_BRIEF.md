...
| Metric | Value |
|--------|-------|
| Total entries | 29,880 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,077 (open — all new entries here) |
| Next entry ID | 30090 |
...
- Range = ID rounded down to nearest 500 (e.g., 30090 → `entries/30000/`)
...
- **General** (27,077+): All other vocabulary. All new entries go here.
