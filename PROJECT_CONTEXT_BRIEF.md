...
| Metric | Value |
|--------|-------|
| Total entries | 27,120 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,337 (open — all new entries here) |
| Next entry ID | 27329 |
| Candidate words | 1,650 |
| Cross-references | ~15,500 |
| Example sentences | ~107,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 27329 → `entries/27000/`)
...
- **General** (24,337+): All other vocabulary. All new entries go here.
