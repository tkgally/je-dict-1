...
| Metric | Value |
|--------|-------|
| Total entries | 23,466 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,683 (open — all new entries here) |
| Next entry ID | 23668 |
| Candidate words | 2,890 |
| Cross-references | ~6,600 |
| Example sentences | ~95,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 23668 → `entries/23500/`)
...
- **General** (20,683+): All other vocabulary. All new entries go here.
