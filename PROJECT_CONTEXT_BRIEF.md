...
| Metric | Value |
|--------|-------|
| Total entries | 25,887 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,104 (open — all new entries here) |
| Next entry ID | 26095 |
| Candidate words | 1,690 |
| Cross-references | ~12,000 |
| Example sentences | ~103,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 26095 → `entries/26000/`)
...
- **General** (23,104+): All other vocabulary. All new entries go here.
