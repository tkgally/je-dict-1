...
| Metric | Value |
|--------|-------|
| Total entries | 25,671 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,888 (open — all new entries here) |
| Next entry ID | 25879 |
| Candidate words | 1,900 |
| Cross-references | ~11,600 |
| Example sentences | ~102,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 25879 → `entries/25500/`)
...
- **General** (22,888+): All other vocabulary. All new entries go here.
