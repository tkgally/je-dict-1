...
| Metric | Value |
|--------|-------|
| Total entries | 23,281 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,498 (open — all new entries here) |
| Next entry ID | 23483 |
| Candidate words | 3,005 |
...
- Range = ID rounded down to nearest 500 (e.g., 23483 → `entries/23000/`)
...
- **General** (20,498+): All other vocabulary. All new entries go here.
