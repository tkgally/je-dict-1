...
| Metric | Value |
|--------|-------|
| Total entries | 29,142 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,339 (open — all new entries here) |
| Next entry ID | 29352 |
...
- Range = ID rounded down to nearest 500 (e.g., 29352 → `entries/29000/`)
...
- **General** (26,339+): All other vocabulary. All new entries go here.
