...
| Metric | Value |
|--------|-------|
| Total entries | 29,307 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,504 (open — all new entries here) |
| Next entry ID | 29517 |
| Candidate words | 1,216 |
...
- Range = ID rounded down to nearest 500 (e.g., 29517 → `entries/29500/`)
...
- **General** (26,504+): All other vocabulary. All new entries go here.
