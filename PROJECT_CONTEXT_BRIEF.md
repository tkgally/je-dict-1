...
| Metric | Value |
|--------|-------|
| Total entries | 25,038 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,255 (open — all new entries here) |
| Next entry ID | 25246 |
| Candidate words | 2,560 |
| Cross-references | ~10,300 |
| Example sentences | ~100,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 25246 → `entries/25000/`)
...
- **General** (22,255+): All other vocabulary. All new entries go here.
