...
| Metric | Value |
|--------|-------|
| Total entries | 26,133 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,350 (open — all new entries here) |
| Next entry ID | 26341 |
| Candidate words | 1,440 |
| Cross-references | ~12,600 |
| Example sentences | ~104,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 26341 → `entries/26000/`)
...
- **General** (23,350+): All other vocabulary. All new entries go here.
