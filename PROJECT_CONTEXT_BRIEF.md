...
| Metric | Value |
|--------|-------|
| Total entries | 27,140 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,357 (open — all new entries here) |
| Next entry ID | 27349 |
| Candidate words | 1,669 |
| Cross-references | ~15,600 |
| Example sentences | ~108,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 27349 → `entries/27000/`)
...
- **General** (24,357+): All other vocabulary. All new entries go here.
