...
| Metric | Value |
|--------|-------|
| Total entries | 30,088 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,285 (open — all new entries here) |
| Next entry ID | 30298 |
| Candidate words | 1,012 |
| Cross-references | ~17,100 |
| Example sentences | ~117,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 30298 → `entries/30000/`)
...
- **General** (27,285+): All other vocabulary. All new entries go here.
