...
| Metric | Value |
|--------|-------|
| Total entries | 29,803 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,000 (open — all new entries here) |
| Next entry ID | 30013 |
| Candidate words | 1,108 |
...
- Range = ID rounded down to nearest 500 (e.g., 30013 → `entries/30000/`)
...
- **General** (27,000+): All other vocabulary. All new entries go here.
