...
| Metric | Value |
|--------|-------|
| Total entries | 25,408 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,625 (open — all new entries here) |
| Next entry ID | 25616 |
| Candidate words | 2,166 |
| Cross-references | ~11,000 |
| Example sentences | ~102,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 25616 → `entries/25500/`)
...
- **General** (22,625+): All other vocabulary. All new entries go here.
