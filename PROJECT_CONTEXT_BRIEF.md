...
| Metric | Value |
|--------|-------|
| Total entries | 30,330 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,527 (open — all new entries here) |
| Next entry ID | 30540 |
| Candidate words | 985 |
| Cross-references | ~18,000 |
| Example sentences | ~118,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 30540 → `entries/30500/`)
...
- **General** (27,527+): All other vocabulary. All new entries go here.
