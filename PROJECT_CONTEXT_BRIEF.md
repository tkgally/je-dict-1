...
| Metric | Value |
|--------|-------|
| Total entries | 29,011 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,208 (open — all new entries here) |
| Next entry ID | 29221 |
| Candidate words | 1,351 |
| Cross-references | ~16,400 |
| Example sentences | ~114,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 29221 → `entries/29000/`)
...
- **General** (26,208+): All other vocabulary. All new entries go here.
