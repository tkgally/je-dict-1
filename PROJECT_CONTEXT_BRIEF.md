...
| Metric | Value |
|--------|-------|
| Total entries | 23,125 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,342 (open — all new entries here) |
| Next entry ID | 23327 |
| Candidate words | 3,160 |
| Cross-references | ~6,300 |
| Example sentences | ~93,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 23327 → `entries/23000/`)
...
- **General** (20,342+): All other vocabulary. All new entries go here.
