...
| Metric | Value |
|--------|-------|
| Total entries | 25,200 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,417 (open — all new entries here) |
| Next entry ID | 25408 |
| Candidate words | 2,373 |
| Cross-references | ~10,700 |
| Example sentences | ~101,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 25408 → `entries/25000/`)
...
- **General** (22,417+): All other vocabulary. All new entries go here.
