...
| Metric | Value |
|--------|-------|
| Total entries | 28,813 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,030 (open — all new entries here) |
| Next entry ID | 29023 |
| Candidate words | 1,442 |
| Cross-references | ~16,300 |
| Example sentences | ~113,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 29023 → `entries/29000/`)
...
- **General** (26,030+): All other vocabulary. All new entries go here.
