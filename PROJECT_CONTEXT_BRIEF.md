...
| Metric | Value |
|--------|-------|
| Total entries | 29,726 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,923 (open — all new entries here) |
| Next entry ID | 29936 |
| Candidate words | 1,103 |
| Cross-references | ~16,500 |
| Example sentences | ~116,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 29936 → `entries/29500/`)
...
- **General** (26,923+): All other vocabulary. All new entries go here.
