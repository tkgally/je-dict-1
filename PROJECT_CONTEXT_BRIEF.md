...
| Metric | Value |
|--------|-------|
| Total entries | 23,075 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,292 (open — all new entries here) |
| Next entry ID | 23277 |
| Candidate words | 3,209 |
| Cross-references | ~6,300 |
| Example sentences | ~93,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 23277 → `entries/23000/`)
...
- **General** (20,292+): All other vocabulary. All new entries go here.
