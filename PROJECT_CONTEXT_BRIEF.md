...
| Metric | Value |
|--------|-------|
| Total entries | 30,345 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,542 (open — all new entries here) |
| Next entry ID | 30555 |
| Candidate words | 978 |
...
- Range = ID rounded down to nearest 500 (e.g., 30555 → `entries/30500/`)
...
- **General** (27,542+): All other vocabulary. All new entries go here.
