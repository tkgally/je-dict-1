...
| Metric | Value |
|--------|-------|
| Total entries | 29,155 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,352 (open — all new entries here) |
| Next entry ID | 29365 |
| Candidate words | 1,282 |
...
- Range = ID rounded down to nearest 500 (e.g., 29365 → `entries/29000/`)
...
- **General** (26,352+): All other vocabulary. All new entries go here.
