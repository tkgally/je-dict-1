...
| Metric | Value |
|--------|-------|
| Total entries | 23,393 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,610 (open — all new entries here) |
| Next entry ID | 23595 |
| Candidate words | 2,962 |
...
- Range = ID rounded down to nearest 500 (e.g., 23595 → `entries/23500/`)
...
- **General** (20,610+): All other vocabulary. All new entries go here.
