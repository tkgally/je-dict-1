...
| Metric | Value |
|--------|-------|
| Total entries | 23,408 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,625 (open — all new entries here) |
| Next entry ID | 23610 |
| Candidate words | 2,947 |
| Cross-references | ~6,300 |
| Example sentences | ~95,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 23610 → `entries/23500/`)
...
- **General** (20,625+): All other vocabulary. All new entries go here.
