...
| Metric | Value |
|--------|-------|
| Total entries | 26,327 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,544 (open — all new entries here) |
| Next entry ID | 26535 |
| Candidate words | 1,239 |
| Cross-references | ~13,300 |
| Example sentences | ~105,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 26535 → `entries/26500/`)
...
- **General** (23,544+): All other vocabulary. All new entries go here.
