...
| Metric | Value |
|--------|-------|
| Total entries | 23,656 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,873 (open — all new entries here) |
| Next entry ID | 23858 |
| Candidate words | 2,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 23858 → `entries/23500/`)
...
- **General** (20,873+): All other vocabulary. All new entries go here.
