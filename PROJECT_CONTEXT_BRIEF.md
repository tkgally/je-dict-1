...
| Metric | Value |
|--------|-------|
| Total entries | 25,723 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,940 (open — all new entries here) |
| Next entry ID | 25931 |
| Candidate words | 1,858 |
| Cross-references | ~11,600 |
| Example sentences | ~103,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 25931 → `entries/25500/`)
...
- **General** (22,940+): All other vocabulary. All new entries go here.
