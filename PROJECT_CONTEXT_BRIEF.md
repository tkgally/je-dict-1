...
| Metric | Value |
|--------|-------|
| Total entries | 29,322 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,519 (open — all new entries here) |
| Next entry ID | 29532 |
| Candidate words | 1,235 |
| Cross-references | ~16,400 |
| Example sentences | ~115,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 29532 → `entries/29500/`)
...
- **General** (26,519+): All other vocabulary. All new entries go here.
