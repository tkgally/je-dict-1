...
| Metric | Value |
|--------|-------|
| Total entries | 26,992 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,209 (open — all new entries here) |
| Next entry ID | 27201 |
...
- Range = ID rounded down to nearest 500 (e.g., 27201 → `entries/27000/`)
...
- **General** (24,209+): All other vocabulary. All new entries go here.
