...
| Metric | Value |
|--------|-------|
| Total entries | 30,187 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,384 (open — all new entries here) |
| Next entry ID | 30397 |
| Candidate words | 979 |
...
- Range = ID rounded down to nearest 500 (e.g., 30397 → `entries/30000/`)
...
- **General** (27,384+): All other vocabulary. All new entries go here.
