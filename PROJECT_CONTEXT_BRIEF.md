...
| Metric | Value |
|--------|-------|
| Total entries | 23,535 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,752 (open — all new entries here) |
| Next entry ID | 23737 |
| Candidate words | 2,821 |
...
- Range = ID rounded down to nearest 500 (e.g., 23737 → `entries/23500/`)
...
- **General** (20,752+): All other vocabulary. All new entries go here.
