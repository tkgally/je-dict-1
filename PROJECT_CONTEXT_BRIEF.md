...
| Metric | Value |
|--------|-------|
| Total entries | 30,784 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 28,001 (open — all new entries here) |
| Next entry ID | 30994 |
| Candidate words | 175 |
| Cross-references | ~77,600 |
| Example sentences | ~119,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 30994 → `entries/30500/`)
...
- **General** (28,001+): All other vocabulary. All new entries go here.
