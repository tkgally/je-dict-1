...
| Metric | Value |
|--------|-------|
| Total entries | 27,241 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,458 (open — all new entries here) |
| Next entry ID | 27450 |
| Candidate words | 1,671 |
| Cross-references | ~15,600 |
| Example sentences | ~108,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 27450 → `entries/27000/`)
...
- **General** (24,458+): All other vocabulary. All new entries go here.
