...
| Metric | Value |
|--------|-------|
| Total entries | 27,177 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,394 (open — all new entries here) |
| Next entry ID | 27386 |
| Candidate words | 1,641 |
| Cross-references | ~15,600 |
| Example sentences | ~108,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 27386 → `entries/27000/`)
...
- **General** (24,394+): All other vocabulary. All new entries go here.
