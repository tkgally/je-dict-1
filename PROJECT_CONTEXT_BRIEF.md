...
| Metric | Value |
|--------|-------|
| Total entries | 26,202 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,419 (open — all new entries here) |
| Next entry ID | 26410 |
| Candidate words | 1,367 |
...
- Range = ID rounded down to nearest 500 (e.g., 26410 → `entries/26000/`)
...
- **General** (23,419+): All other vocabulary. All new entries go here.
