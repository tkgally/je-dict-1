...
| Metric | Value |
|--------|-------|
| Total entries | 30,824 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 28,041 (open — all new entries here) |
| Next entry ID | 31034 |
| Candidate words | 146 |
...
- Range = ID rounded down to nearest 500 (e.g., 31034 → `entries/31000/`)
...
- **General** (28,041+): All other vocabulary. All new entries go here.
