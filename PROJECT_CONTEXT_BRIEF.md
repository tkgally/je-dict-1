...
| General tier | 20,713 (open — all new entries here) |
| Next entry ID | 23698 |
| Candidate words | 2,860 |
| Cross-references | ~7,000 |
| Example sentences | ~95,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 23698 → `entries/23500/`)
...
- **General** (20,713+): All other vocabulary. All new entries go here.
