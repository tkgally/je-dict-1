...
| General tier | 24,615 (open — all new entries here) |
| Next entry ID | 27607 |
| Candidate words | 1,647 |
| Cross-references | ~15,700 |
| Example sentences | ~108,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 27607 → `entries/27500/`)
...
- **General** (24,615+): All other vocabulary. All new entries go here.
