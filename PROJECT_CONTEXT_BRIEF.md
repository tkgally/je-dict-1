...
| Metric | Value |
|--------|-------|
| Total entries | 29,895 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,092 (open — all new entries here) |
| Next entry ID | 30105 |
| Candidate words | 1,061 |
...
- Range = ID rounded down to nearest 500 (e.g., 30105 → `entries/30000/`)
...
- **General** (27,092+): All other vocabulary. All new entries go here.
