...
| Metric | Value |
|--------|-------|
| Total entries | 23,313 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,530 (open — all new entries here) |
| Next entry ID | 23515 |
| Candidate words | 3,042 |
| Cross-references | ~6,300 |
| Example sentences | ~94,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 23515 → `entries/23500/`)
...
- **General** (20,530+): All other vocabulary. All new entries go here.
