...
| Metric | Value |
|--------|-------|
| Total entries | 30,385 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,582 (open — all new entries here) |
| Next entry ID | 30595 |
| Candidate words | 167 |
| Cross-references | ~18,200 |
| Example sentences | ~118,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 30595 → `entries/30500/`)
...
- **General** (27,582+): All other vocabulary. All new entries go here.
