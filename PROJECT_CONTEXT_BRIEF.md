...
| Metric | Value |
|--------|-------|
| Total entries | 29,092 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,289 (open — all new entries here) |
| Next entry ID | 29302 |
...
- Range = ID rounded down to nearest 500 (e.g., 29302 → `entries/29000/`)
...
- **General** (26,289+): All other vocabulary. All new entries go here.
