...
| Metric | Value |
|--------|-------|
| Total entries | 29,219 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,416 (open — all new entries here) |
| Next entry ID | 29429 |
| Candidate words | 1,259 |
| Cross-references | ~16,400 |
| Example sentences | ~114,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 29429 → `entries/29000/`)
...
- **General** (26,416+): All other vocabulary. All new entries go here.
