...
| Metric | Value |
|--------|-------|
| Total entries | 23,364 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,581 (open — all new entries here) |
| Next entry ID | 23566 |
| Candidate words | 2,991 |
| Cross-references | ~6,300 |
| Example sentences | ~94,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 23566 → `entries/23500/`)
...
- **General** (20,581+): All other vocabulary. All new entries go here.
