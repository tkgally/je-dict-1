...
| Metric | Value |
|--------|-------|
| Total entries | 28,893 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,110 (open — all new entries here) |
| Next entry ID | 29103 |
| Candidate words | 1,447 |
...
- Range = ID rounded down to nearest 500 (e.g., 29103 → `entries/29000/`)
...
- **General** (26,110+): All other vocabulary. All new entries go here.
