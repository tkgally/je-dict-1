...
| Metric | Value |
|--------|-------|
| Total entries | 27,649 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,866 (open — all new entries here) |
| Next entry ID | 27858 |
| Candidate words | 1,750 |
| Cross-references | ~15,900 |
| Example sentences | ~109,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 27858 → `entries/27500/`)
...
- **General** (24,866+): All other vocabulary. All new entries go here.
