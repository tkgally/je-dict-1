...
| General tier | 27,661 (open — all new entries here) |
| Next entry ID | 30674 |
| Candidate words | 154 |
| Cross-references | ~18,600 |
| Example sentences | ~118,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 30674 → `entries/30500/`)
...
- **General** (27,661+): All other vocabulary. All new entries go here.
