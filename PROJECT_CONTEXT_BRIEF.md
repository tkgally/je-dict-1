...
| Metric | Value |
|--------|-------|
| Total entries | 24,879 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,096 (open — all new entries here) |
| Next entry ID | 25082 |
| Candidate words | 1,461 |
| Cross-references | ~9,400 |
| Example sentences | ~100,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 25082 → `entries/25000/`)
...
- **General** (22,096+): All other vocabulary. All new entries go here.
