...
| Metric | Value |
|--------|-------|
| Total entries | 29,169 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,366 (open — all new entries here) |
| Next entry ID | 29379 |
...
- Range = ID rounded down to nearest 500 (e.g., 29379 → `entries/29000/`)
...
- **General** (26,366+): All other vocabulary. All new entries go here.
