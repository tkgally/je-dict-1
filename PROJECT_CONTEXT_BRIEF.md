...
| Metric | Value |
|--------|-------|
| Total entries | 26,732 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,949 (open — all new entries here) |
| Next entry ID | 26941 |
| Candidate words | 1,970 |
| Cross-references | ~14,500 |
| Example sentences | ~106,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 26941 → `entries/26500/`)
...
- **General** (23,949+): All other vocabulary. All new entries go here.
