...
| General tier | 21,553 (open — all new entries here) |
| Next entry ID | 24539 |
| Candidate words | 2,014 |
| Cross-references | ~8,200 |
| Example sentences | ~98,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 24539 → `entries/24500/`)
...
- **General** (21,553+): All other vocabulary. All new entries go here.
