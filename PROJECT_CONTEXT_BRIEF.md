...
| Metric | Value |
|--------|-------|
| Total entries | 28,320 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,537 (open — all new entries here) |
| Next entry ID | 28529 |
| Candidate words | 1,559 |
| Cross-references | ~16,200 |
| Example sentences | ~111,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 28529 → `entries/28500/`)
...
- **General** (25,537+): All other vocabulary. All new entries go here.
