...
| Metric | Value |
|--------|-------|
| Total entries | 30,564 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,761 (open — all new entries here) |
| Next entry ID | 30774 |
| Candidate words | 152 |
...
- Range = ID rounded down to nearest 500 (e.g., 30774 → `entries/30500/`)
...
- **General** (27,761+): All other vocabulary. All new entries go here.
