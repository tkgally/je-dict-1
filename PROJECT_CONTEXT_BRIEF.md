...
| Metric | Value |
|--------|-------|
| Total entries | 29,714 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,911 (open — all new entries here) |
| Next entry ID | 29924 |
| Candidate words | 1,116 |
...
- Range = ID rounded down to nearest 500 (e.g., 29924 → `entries/29500/`)
...
- **General** (26,911+): All other vocabulary. All new entries go here.
