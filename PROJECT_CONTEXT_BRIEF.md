...
| Metric | Value |
|--------|-------|
| Total entries | 25,938 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,155 (open — all new entries here) |
| Next entry ID | 26146 |
...
- Range = ID rounded down to nearest 500 (e.g., 26146 → `entries/26000/`)
...
- **General** (23,155+): All other vocabulary. All new entries go here.
