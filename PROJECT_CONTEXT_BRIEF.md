...
| Metric | Value |
|--------|-------|
| Total entries | 29,383 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,580 (open — all new entries here) |
| Next entry ID | 29593 |
| Candidate words | 1,203 |
...
- Range = ID rounded down to nearest 500 (e.g., 29593 → `entries/29500/`)
...
- **General** (26,580+): All other vocabulary. All new entries go here.
