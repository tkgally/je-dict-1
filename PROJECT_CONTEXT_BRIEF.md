...
| Metric | Value |
|--------|-------|
| Total entries | 26,777 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,994 (open — all new entries here) |
| Next entry ID | 26986 |
| Candidate words | 1,920 |
| Cross-references | ~14,700 |
| Example sentences | ~106,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 26986 → `entries/26500/`)
...
- **General** (23,994+): All other vocabulary. All new entries go here.
