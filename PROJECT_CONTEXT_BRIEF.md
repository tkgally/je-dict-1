...
| Metric | Value |
|--------|-------|
| Total entries | 30,504 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,701 (open — all new entries here) |
| Next entry ID | 30714 |
| Candidate words | 154 |
| Cross-references | ~18,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 30714 → `entries/30500/`)
...
- **General** (27,701+): All other vocabulary. All new entries go here.
