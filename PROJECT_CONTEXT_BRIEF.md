...
| Metric | Value |
|--------|-------|
| Total entries | 25,548 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,765 (open — all new entries here) |
| Next entry ID | 25756 |
| Candidate words | 2,026 |
| Cross-references | ~11,400 |
| Example sentences | ~102,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 25756 → `entries/25500/`)
...
- **General** (22,765+): All other vocabulary. All new entries go here.
