...
| Metric | Value |
|--------|-------|
| Total entries | 27,074 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,291 (open — all new entries here) |
| Next entry ID | 27283 |
| Candidate words | 1,675 |
| Cross-references | ~15,500 |
| Example sentences | ~107,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 27283 → `entries/27000/`)
...
- **General** (24,291+): All other vocabulary. All new entries go here.
