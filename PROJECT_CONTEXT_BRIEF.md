...
| Metric | Value |
|--------|-------|
| Total entries | 24,251 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,468 (open — all new entries here) |
| Next entry ID | 24454 |
| Candidate words | 2,099 |
| Cross-references | ~8,200 |
| Example sentences | ~98,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 24454 → `entries/24000/`)
...
- **General** (21,468+): All other vocabulary. All new entries go here.
