...
| Metric | Value |
|--------|-------|
| Total entries | 23,418 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,635 (open — all new entries here) |
| Next entry ID | 23620 |
| Candidate words | 2,937 |
| Cross-references | ~6,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 23620 → `entries/23500/`)
...
- **General** (20,635+): All other vocabulary. All new entries go here.
