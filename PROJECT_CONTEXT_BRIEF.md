...
| Metric | Value |
|--------|-------|
| Total entries | 23,095 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,312 (open — all new entries here) |
| Next entry ID | 23297 |
| Candidate words | 3,189 |
| Cross-references | ~6,300 |
| Example sentences | ~93,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 23297 → `entries/23000/`)
...
- **General** (20,312+): All other vocabulary. All new entries go here.
