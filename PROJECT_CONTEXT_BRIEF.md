...
| Metric | Value |
|--------|-------|
| Total entries | 23,571 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,788 (open — all new entries here) |
| Next entry ID | 23773 |
| Candidate words | 2,785 |
| Cross-references | ~7,400 |
| Example sentences | ~95,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 23773 → `entries/23500/`)
...
- **General** (20,788+): All other vocabulary. All new entries go here.
