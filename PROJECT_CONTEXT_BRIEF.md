...
| Metric | Value |
|--------|-------|
| Total entries | 28,447 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,664 (open — all new entries here) |
| Next entry ID | 28656 |
| Candidate words | 1,535 |
| Cross-references | ~16,200 |
| Example sentences | ~112,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 28656 → `entries/28500/`)
...
- **General** (25,664+): All other vocabulary. All new entries go here.
