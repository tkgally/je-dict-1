...
| Metric | Value |
|--------|-------|
| Total entries | 23,623 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,840 (open — all new entries here) |
| Next entry ID | 23825 |
| Candidate words | 2,733 |
| Cross-references | ~7,400 |
| Example sentences | ~95,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 23825 → `entries/23500/`)
...
- **General** (20,840+): All other vocabulary. All new entries go here.
