...
| Metric | Value |
|--------|-------|
| Total entries | 23,509 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,726 (open — all new entries here) |
| Next entry ID | 23711 |
| Candidate words | 2,847 |
...
- Range = ID rounded down to nearest 500 (e.g., 23711 → `entries/23500/`)
...
- **General** (20,726+): All other vocabulary. All new entries go here.
