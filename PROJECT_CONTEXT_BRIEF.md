...
| Metric | Value |
|--------|-------|
| Total entries | 29,525 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,722 (open — all new entries here) |
| Next entry ID | 29735 |
| Candidate words | 1,175 |
...
- Range = ID rounded down to nearest 500 (e.g., 29735 → `entries/29500/`)
...
- **General** (26,722+): All other vocabulary. All new entries go here.
