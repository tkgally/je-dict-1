...
| Metric | Value |
|--------|-------|
| Total entries | 27,052 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,269 (open — all new entries here) |
| Next entry ID | 27261 |
...
- Range = ID rounded down to nearest 500 (e.g., 27261 → `entries/27000/`)
...
- **General** (24,269+): All other vocabulary. All new entries go here.
