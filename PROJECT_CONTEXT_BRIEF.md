...
| Metric | Value |
|--------|-------|
| Total entries | 29,678 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,875 (open — all new entries here) |
| Next entry ID | 29888 |
...
- Range = ID rounded down to nearest 500 (e.g., 29888 → `entries/29500/`)
...
- **General** (26,875+): All other vocabulary. All new entries go here.
