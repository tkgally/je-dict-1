...
| Metric | Value |
|--------|-------|
| Total entries | 27,556 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,773 (open — all new entries here) |
| Next entry ID | 27765 |
| Candidate words | 1,688 |
| Cross-references | ~15,800 |
| Example sentences | ~109,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 27765 → `entries/27500/`)
...
- **General** (24,773+): All other vocabulary. All new entries go here.
