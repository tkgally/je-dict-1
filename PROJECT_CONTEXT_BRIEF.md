...
| Metric | Value |
|--------|-------|
| Total entries | 24,859 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,076 (open — all new entries here) |
| Next entry ID | 25062 |
...
- Range = ID rounded down to nearest 500 (e.g., 25062 → `entries/25000/`)
...
- **General** (22,076+): All other vocabulary. All new entries go here.
