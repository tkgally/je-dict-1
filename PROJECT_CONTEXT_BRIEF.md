...
| Metric | Value |
|--------|-------|
| Total entries | 28,603 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,820 (open — all new entries here) |
| Next entry ID | 28813 |
| Candidate words | 1,516 |
| Cross-references | ~16,200 |
| Example sentences | ~112,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 28813 → `entries/28500/`)
...
- **General** (25,820+): All other vocabulary. All new entries go here.
