...
| Metric | Value |
|--------|-------|
| Total entries | 23,187 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,404 (open — all new entries here) |
| Next entry ID | 23389 |
| Candidate words | 3,099 |
...
- Range = ID rounded down to nearest 500 (e.g., 23389 → `entries/23000/`)
...
- **General** (20,404+): All other vocabulary. All new entries go here.
