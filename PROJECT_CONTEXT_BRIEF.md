...
| Metric | Value |
|--------|-------|
| Total entries | 28,769 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,986 (open — all new entries here) |
| Next entry ID | 28979 |
| Candidate words | 1,475 |
| Cross-references | ~16,300 |
| Example sentences | ~113,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 28979 → `entries/28500/`)
...
- **General** (25,986+): All other vocabulary. All new entries go here.
