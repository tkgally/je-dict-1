...
| Metric | Value |
|--------|-------|
| Total entries | 23,987 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,204 (open — all new entries here) |
| Next entry ID | 24189 |
| Candidate words | 2,366 |
| Cross-references | ~7,700 |
| Example sentences | ~97,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 24189 → `entries/24000/`)
...
- **General** (21,204+): All other vocabulary. All new entries go here.
