...
| Metric | Value |
|--------|-------|
| Total entries | 29,420 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,617 (open — all new entries here) |
| Next entry ID | 29630 |
| Candidate words | 1,187 |
| Cross-references | ~16,500 |
| Example sentences | ~115,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 29630 → `entries/29500/`)
...
- **General** (26,617+): All other vocabulary. All new entries go here.
