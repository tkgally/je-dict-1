...
| Metric | Value |
|--------|-------|
| Total entries | 27,420 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,637 (open — all new entries here) |
| Next entry ID | 27629 |
...
- Range = ID rounded down to nearest 500 (e.g., 27629 → `entries/27500/`)
...
- **General** (24,637+): All other vocabulary. All new entries go here.
