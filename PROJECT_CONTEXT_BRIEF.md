...
| Metric | Value |
|--------|-------|
| Total entries | 29,403 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,600 (open — all new entries here) |
| Next entry ID | 29613 |
| Candidate words | 1,192 |
| Cross-references | ~16,400 |
| Example sentences | ~115,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 29613 → `entries/29500/`)
...
- **General** (26,600+): All other vocabulary. All new entries go here.
