...
| Metric | Value |
|--------|-------|
| Total entries | 23,641 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,858 (open — all new entries here) |
| Next entry ID | 23843 |
| Candidate words | 2,715 |
...
- Range = ID rounded down to nearest 500 (e.g., 23843 → `entries/23500/`)
...
- **General** (20,858+): All other vocabulary. All new entries go here.
