...
| Metric | Value |
|--------|-------|
| Total entries | 29,445 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,642 (open — all new entries here) |
| Next entry ID | 29655 |
...
- Range = ID rounded down to nearest 500 (e.g., 29655 → `entries/29500/`)
...
- **General** (26,642+): All other vocabulary. All new entries go here.
