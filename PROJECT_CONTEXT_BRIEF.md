...
| Metric | Value |
|--------|-------|
| Total entries | 25,318 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,535 (open — all new entries here) |
| Next entry ID | 25526 |
| Candidate words | 2,256 |
| Cross-references | ~10,700 |
| Example sentences | ~101,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 25526 → `entries/25500/`)
...
- **General** (22,535+): All other vocabulary. All new entries go here.
