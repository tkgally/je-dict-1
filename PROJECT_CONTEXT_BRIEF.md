...
| Metric | Value |
|--------|-------|
| Total entries | 24,641 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,858 (open — all new entries here) |
| Next entry ID | 24844 |
| Candidate words | 1,710 |
| Cross-references | ~8,800 |
| Example sentences | ~99,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 24844 → `entries/24500/`)
...
- **General** (21,858+): All other vocabulary. All new entries go here.
