...
| Metric | Value |
|--------|-------|
| Total entries | 30,049 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,246 (open — all new entries here) |
| Next entry ID | 30259 |
| Candidate words | 1,018 |
| Cross-references | ~16,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 30259 → `entries/30000/`)
...
- **General** (27,246+): All other vocabulary. All new entries go here.
