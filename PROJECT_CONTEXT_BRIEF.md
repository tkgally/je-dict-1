...
| Metric | Value |
|--------|-------|
| Total entries | 24,790 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,007 (open — all new entries here) |
| Next entry ID | 24993 |
| Candidate words | 1,554 |
| Cross-references | ~9,400 |
| Example sentences | ~99,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 24993 → `entries/24500/`)
...
- **General** (22,007+): All other vocabulary. All new entries go here.
