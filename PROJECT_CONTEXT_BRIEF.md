...
| Metric | Value |
|--------|-------|
| Total entries | 23,173 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,390 (open — all new entries here) |
| Next entry ID | 23375 |
| Candidate words | 3,113 |
| Cross-references | ~6,300 |
| Example sentences | ~94,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 23375 → `entries/23000/`)
...
- **General** (20,390+): All other vocabulary. All new entries go here.
