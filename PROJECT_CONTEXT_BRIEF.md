...
| Metric | Value |
|--------|-------|
| Total entries | 22,991 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,208 (open — all new entries here) |
| Next entry ID | 23193 |
| Candidate words | 3,295 |
| Cross-references | ~5,900 |
| Example sentences | ~93,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 23193 → `entries/23000/`)
...
- **General** (20,208+): All other vocabulary. All new entries go here.
