...
| Metric | Value |
|--------|-------|
| Total entries | 27,603 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,820 (open — all new entries here) |
| Next entry ID | 27812 |
| Candidate words | 1,738 |
...
- Range = ID rounded down to nearest 500 (e.g., 27812 → `entries/27500/`)
...
- **General** (24,820+): All other vocabulary. All new entries go here.
