...
| Metric | Value |
|--------|-------|
| Total entries | 26,153 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,370 (open — all new entries here) |
| Next entry ID | 26361 |
| Candidate words | 1,420 |
...
- Range = ID rounded down to nearest 500 (e.g., 26361 → `entries/26000/`)
...
- **General** (23,370+): All other vocabulary. All new entries go here.
