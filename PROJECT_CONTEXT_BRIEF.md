...
| Metric | Value |
|--------|-------|
| Total entries | 29,180 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,377 (open — all new entries here) |
| Next entry ID | 29390 |
| Candidate words | 1,280 |
| Cross-references | ~16,400 |
| Example sentences | ~114,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 29390 → `entries/29000/`)
...
- **General** (26,377+): All other vocabulary. All new entries go here.
