...
| Metric | Value |
|--------|-------|
| Total entries | 27,155 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,372 (open — all new entries here) |
| Next entry ID | 27364 |
| Candidate words | 1,654 |
| Cross-references | ~15,600 |
| Example sentences | ~108,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 27364 → `entries/27000/`)
...
- **General** (24,372+): All other vocabulary. All new entries go here.
