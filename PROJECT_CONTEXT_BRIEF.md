...
| Metric | Value |
|--------|-------|
| Total entries | 28,015 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,232 (open — all new entries here) |
| Next entry ID | 28224 |
| Candidate words | 1,646 |
| Cross-references | ~16,100 |
| Example sentences | ~110,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 28224 → `entries/28000/`)
...
- **General** (25,232+): All other vocabulary. All new entries go here.
