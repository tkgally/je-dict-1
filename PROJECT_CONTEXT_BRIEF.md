...
| Metric | Value |
|--------|-------|
| Total entries | 27,221 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,438 (open — all new entries here) |
| Next entry ID | 27430 |
| Candidate words | 1,673 |
| Cross-references | ~15,600 |
| Example sentences | ~108,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 27430 → `entries/27000/`)
...
- **General** (24,438+): All other vocabulary. All new entries go here.
