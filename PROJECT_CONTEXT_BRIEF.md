...
| Metric | Value |
|--------|-------|
| Total entries | 25,438 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,655 (open — all new entries here) |
| Next entry ID | 25646 |
| Candidate words | 2,136 |
| Cross-references | ~11,000 |
| Example sentences | ~102,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 25646 → `entries/25500/`)
...
- **General** (22,655+): All other vocabulary. All new entries go here.
