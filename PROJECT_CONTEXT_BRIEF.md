...
| Metric | Value |
|--------|-------|
| Total entries | 30,148 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,345 (open — all new entries here) |
| Next entry ID | 30358 |
| Candidate words | 1,003 |
| Cross-references | ~17,300 |
| Example sentences | ~117,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 30358 → `entries/30000/`)
...
- **General** (27,345+): All other vocabulary. All new entries go here.
