...
| Metric | Value |
|--------|-------|
| Total entries | 29,915 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,112 (open — all new entries here) |
| Next entry ID | 30125 |
| Candidate words | 1,050 |
| Cross-references | ~16,600 |
| Example sentences | ~116,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 30125 → `entries/30000/`)
...
- **General** (27,112+): All other vocabulary. All new entries go here.
