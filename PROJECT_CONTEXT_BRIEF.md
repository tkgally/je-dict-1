...
| Metric | Value |
|--------|-------|
| Total entries | 24,386 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,603 (open — all new entries here) |
| Next entry ID | 24589 |
| Candidate words | 1,964 |
...
- Range = ID rounded down to nearest 500 (e.g., 24589 → `entries/24500/`)
...
- **General** (21,603+): All other vocabulary. All new entries go here.
