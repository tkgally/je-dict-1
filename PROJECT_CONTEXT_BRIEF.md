...
| Metric | Value |
|--------|-------|
| Total entries | 29,609 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,806 (open — all new entries here) |
| Next entry ID | 29819 |
| Candidate words | 1,145 |
| Cross-references | ~16,500 |
| Example sentences | ~115,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 29819 → `entries/29500/`)
...
- **General** (26,806+): All other vocabulary. All new entries go here.
