...
| Metric | Value |
|--------|-------|
| Total entries | 23,433 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,650 (open — all new entries here) |
| Next entry ID | 23635 |
| Candidate words | 2,923 |
| Cross-references | ~6,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 23635 → `entries/23500/`)
...
- **General** (20,650+): All other vocabulary. All new entries go here.
