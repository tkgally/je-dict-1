...
| Metric | Value |
|--------|-------|
| Total entries | 24,735 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,952 (open — all new entries here) |
| Next entry ID | 24938 |
| Candidate words | 1,609 |
| Cross-references | ~8,800 |
| Example sentences | ~99,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 24938 → `entries/24500/`)
...
- **General** (21,952+): All other vocabulary. All new entries go here.
