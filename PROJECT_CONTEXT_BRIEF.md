...
| Metric | Value |
|--------|-------|
| Total entries | 24,760 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,977 (open — all new entries here) |
| Next entry ID | 24963 |
| Candidate words | 1,584 |
| Cross-references | ~9,100 |
| Example sentences | ~99,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 24963 → `entries/24500/`)
...
- **General** (21,977+): All other vocabulary. All new entries go here.
