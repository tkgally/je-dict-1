...
| Metric | Value |
|--------|-------|
| Total entries | 26,008 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,225 (open — all new entries here) |
| Next entry ID | 26216 |
| Candidate words | 1,564 |
| Cross-references | ~12,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 26216 → `entries/26000/`)
...
- **General** (23,225+): All other vocabulary. All new entries go here.
