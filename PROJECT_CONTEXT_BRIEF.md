...
| Metric | Value |
|--------|-------|
| Total entries | 23,841 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,058 (open — all new entries here) |
| Next entry ID | 24043 |
| Candidate words | 2,513 |
| Cross-references | ~7,500 |
| Example sentences | ~96,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 24043 → `entries/24000/`)
...
- **General** (21,058+): All other vocabulary. All new entries go here.
