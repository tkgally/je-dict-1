...
| General tier | 27,981 (open — all new entries here) |
| Next entry ID | 30974 |
| Candidate words | 190 |
...
- Range = ID rounded down to nearest 500 (e.g., 30974 → `entries/30500/`)
...
- **General** (27,981+): All other vocabulary. All new entries go here.
