...
| Metric | Value |
|--------|-------|
| Total entries | 30,128 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,325 (open — all new entries here) |
| Next entry ID | 30338 |
| Candidate words | 1,009 |
| Cross-references | ~17,300 |
| Example sentences | ~117,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 30338 → `entries/30000/`)
...
- **General** (27,325+): All other vocabulary. All new entries go here.
