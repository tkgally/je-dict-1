...
| Metric | Value |
|--------|-------|
| Total entries | 23,378 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,595 (open — all new entries here) |
| Next entry ID | 23580 |
| Candidate words | 2,977 |
| Cross-references | ~6,300 |
| Example sentences | ~94,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 23580 → `entries/23500/`)
...
- **General** (20,595+): All other vocabulary. All new entries go here.
