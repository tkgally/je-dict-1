...
| Metric | Value |
|--------|-------|
| Total entries | 28,187 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,404 (open — all new entries here) |
| Next entry ID | 28396 |
...
- Range = ID rounded down to nearest 500 (e.g., 28396 → `entries/28000/`)
...
- **General** (25,404+): All other vocabulary. All new entries go here.
