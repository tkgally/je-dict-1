...
| Metric | Value |
|--------|-------|
| Total entries | 29,199 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,396 (open — all new entries here) |
| Next entry ID | 29409 |
| Candidate words | 1,273 |
| Cross-references | ~16,400 |
| Example sentences | ~114,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 29409 → `entries/29000/`)
...
- **General** (26,396+): All other vocabulary. All new entries go here.
