...
| Metric | Value |
|--------|-------|
| Total entries | 25,348 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,565 (open — all new entries here) |
| Next entry ID | 25556 |
| Candidate words | 2,226 |
| Cross-references | ~10,800 |
| Example sentences | ~101,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 25556 → `entries/25500/`)
...
- **General** (22,565+): All other vocabulary. All new entries go here.
