...
| Metric | Value |
|--------|-------|
| Total entries | 25,378 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,595 (open — all new entries here) |
| Next entry ID | 25586 |
| Candidate words | 2,196 |
| Cross-references | ~11,000 |
| Example sentences | ~101,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 25586 → `entries/25500/`)
...
- **General** (22,595+): All other vocabulary. All new entries go here.
