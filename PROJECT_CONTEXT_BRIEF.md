...
| Metric | Value |
|--------|-------|
| Total entries | 28,561 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,778 (open — all new entries here) |
| Next entry ID | 28771 |
| Candidate words | 1,557 |
| Cross-references | ~16,200 |
| Example sentences | ~112,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 28771 → `entries/28500/`)
...
- **General** (25,778+): All other vocabulary. All new entries go here.
