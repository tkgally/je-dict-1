...
| Metric | Value |
|--------|-------|
| Total entries | 30,264 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,461 (open — all new entries here) |
| Next entry ID | 30474 |
| Candidate words | 993 |
| Cross-references | ~17,700 |
| Example sentences | ~118,000 |
...
- Range = ID rounded down to nearest 500 (e.g., 30474 → `entries/30000/`)
...
- **General** (27,461+): All other vocabulary. All new entries go here.
