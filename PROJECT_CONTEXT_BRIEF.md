...
| Metric | Value |
|--------|-------|
| Total entries | 27,354 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,571 (open — all new entries here) |
| Next entry ID | 27563 |
...
- Range = ID rounded down to nearest 500 (e.g., 27563 → `entries/27500/`)
...
- **General** (24,571+): All other vocabulary. All new entries go here.
