...
| Metric | Value |
|--------|-------|
| Total entries | 27,200 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,417 (open — all new entries here) |
| Next entry ID | 27409 |
| Candidate words | 1,657 |
...
- Range = ID rounded down to nearest 500 (e.g., 27409 → `entries/27000/`)
...
- **General** (24,417+): All other vocabulary. All new entries go here.
