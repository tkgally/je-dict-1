...
| Metric | Value |
|--------|-------|
| Total entries | 26,972 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,189 (open — all new entries here) |
| Next entry ID | 27181 |
| Candidate words | 1,682 |
| Cross-references | ~15,000 |
| Example sentences | ~107,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 27181 → `entries/27000/`)
...
- **General** (24,189+): All other vocabulary. All new entries go here.
