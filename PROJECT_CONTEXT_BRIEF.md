...
| Metric | Value |
|--------|-------|
| Total entries | 27,378 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,595 (open — all new entries here) |
| Next entry ID | 27587 |
| Candidate words | 1,655 |
| Cross-references | ~15,600 |
| Example sentences | ~108,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 27587 → `entries/27500/`)
...
- **General** (24,595+): All other vocabulary. All new entries go here.
