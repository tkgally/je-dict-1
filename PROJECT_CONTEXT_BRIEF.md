...
| Metric | Value |
|--------|-------|
| Total entries | 27,581 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,798 (open — all new entries here) |
| Next entry ID | 27790 |
| Candidate words | 1,703 |
| Cross-references | ~15,900 |
| Example sentences | ~109,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 27790 → `entries/27500/`)
...
- **General** (24,798+): All other vocabulary. All new entries go here.
