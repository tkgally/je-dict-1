...
| Metric | Value |
|--------|-------|
| Total entries | 24,458 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,675 (open — all new entries here) |
| Next entry ID | 24661 |
| Candidate words | 1,896 |
| Cross-references | ~8,800 |
| Example sentences | ~98,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 24661 → `entries/24500/`)
...
- **General** (21,675+): All other vocabulary. All new entries go here.
