...
| Metric | Value |
|--------|-------|
| Total entries | 27,881 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,098 (open — all new entries here) |
| Next entry ID | 28090 |
| Candidate words | 1,674 |
| Cross-references | ~16,100 |
| Example sentences | ~110,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 28090 → `entries/28000/`)
...
- **General** (25,098+): All other vocabulary. All new entries go here.
