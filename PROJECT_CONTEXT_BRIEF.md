...
| Metric | Value |
|--------|-------|
| Total entries | 23,203 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,420 (open — all new entries here) |
| Next entry ID | 23405 |
| Candidate words | 3,083 |
| Cross-references | ~6,300 |
| Example sentences | ~94,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 23405 → `entries/23000/`)
...
- **General** (20,420+): All other vocabulary. All new entries go here.
