...
| Metric | Value |
|--------|-------|
| Total entries | 29,510 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,707 (open — all new entries here) |
| Next entry ID | 29720 |
| Candidate words | 1,178 |
| Cross-references | ~16,500 |
| Example sentences | ~115,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 29720 → `entries/29500/`)
...
- **General** (26,707+): All other vocabulary. All new entries go here.
