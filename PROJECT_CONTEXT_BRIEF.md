...
| Metric | Value |
|--------|-------|
| Total entries | 28,628 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,845 (open — all new entries here) |
| Next entry ID | 28838 |
| Candidate words | 1,523 |
| Cross-references | ~16,300 |
| Example sentences | ~112,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 28838 → `entries/28500/`)
...
- **General** (25,845+): All other vocabulary. All new entries go here.
