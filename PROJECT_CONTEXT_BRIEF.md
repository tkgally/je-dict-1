...
| Metric | Value |
|--------|-------|
| Total entries | 28,422 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,639 (open — all new entries here) |
| Next entry ID | 28631 |
...
- Range = ID rounded down to nearest 500 (e.g., 28631 → `entries/28500/`)
...
- **General** (25,639+): All other vocabulary. All new entries go here.
