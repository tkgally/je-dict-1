...
| Metric | Value |
|--------|-------|
| Total entries | 25,751 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,968 (open — all new entries here) |
| Next entry ID | 25959 |
| Candidate words | 1,831 |
| Cross-references | ~11,600 |
| Example sentences | ~103,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 25959 → `entries/25500/`)
...
- **General** (22,968+): All other vocabulary. All new entries go here.
