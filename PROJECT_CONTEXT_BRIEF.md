...
| Metric | Value |
|--------|-------|
| Total entries | 28,651 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,868 (open — all new entries here) |
| Next entry ID | 28861 |
| Candidate words | 1,501 |
| Cross-references | ~16,300 |
| Example sentences | ~112,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 28861 → `entries/28500/`)
...
- **General** (25,868+): All other vocabulary. All new entries go here.
