...
| Metric | Value |
|--------|-------|
| Total entries | 26,028 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,245 (open — all new entries here) |
| Next entry ID | 26236 |
| Candidate words | 1,544 |
| Cross-references | ~12,600 |
| Example sentences | ~104,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 26236 → `entries/26000/`)
...
- **General** (23,245+): All other vocabulary. All new entries go here.
