...
| Metric | Value |
|--------|-------|
| Total entries | 27,903 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,120 (open — all new entries here) |
| Next entry ID | 28112 |
| Candidate words | 1,671 |
...
- Range = ID rounded down to nearest 500 (e.g., 28112 → `entries/28000/`)
...
- **General** (25,120+): All other vocabulary. All new entries go here.
