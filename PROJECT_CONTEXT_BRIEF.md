...
| Metric | Value |
|--------|-------|
| Total entries | 23,894 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,111 (open — all new entries here) |
| Next entry ID | 24096 |
| Candidate words | 2,461 |
| Cross-references | ~7,700 |
| Example sentences | ~96,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 24096 → `entries/24000/`)
...
- **General** (21,111+): All other vocabulary. All new entries go here.
