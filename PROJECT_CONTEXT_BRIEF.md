...
| Metric | Value |
|--------|-------|
| Total entries | 26,365 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,582 (open — all new entries here) |
| Next entry ID | 26573 |
| Candidate words | 1,155 |
| Cross-references | ~13,600 |
| Example sentences | ~105,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 26573 → `entries/26500/`)
...
- **General** (23,582+): All other vocabulary. All new entries go here.
