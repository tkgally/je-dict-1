...
| Metric | Value |
|--------|-------|
| Total entries | 28,168 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,385 (open — all new entries here) |
| Next entry ID | 28377 |
| Candidate words | 1,557 |
| Cross-references | ~16,100 |
| Example sentences | ~111,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 28377 → `entries/28000/`)
...
- **General** (25,385+): All other vocabulary. All new entries go here.
