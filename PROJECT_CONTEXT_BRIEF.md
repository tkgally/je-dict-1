...
| Metric | Value |
|--------|-------|
| Total entries | 25,288 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,505 (open — all new entries here) |
| Next entry ID | 25496 |
| Candidate words | 2,285 |
| Cross-references | ~10,700 |
| Example sentences | ~101,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 25496 → `entries/25000/`)
...
- **General** (22,505+): All other vocabulary. All new entries go here.
