...
| Metric | Value |
|--------|-------|
| Total entries | 27,331 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,548 (open — all new entries here) |
| Next entry ID | 27540 |
| Candidate words | 1,695 |
| Cross-references | ~15,600 |
| Example sentences | ~108,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 27540 → `entries/27500/`)
...
- **General** (24,548+): All other vocabulary. All new entries go here.
