...
| Metric | Value |
|--------|-------|
| Total entries | 25,063 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,280 (open — all new entries here) |
| Next entry ID | 25271 |
| Candidate words | 2,510 |
| Cross-references | ~10,300 |
| Example sentences | ~100,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 25271 → `entries/25000/`)
...
- **General** (22,280+): All other vocabulary. All new entries go here.
