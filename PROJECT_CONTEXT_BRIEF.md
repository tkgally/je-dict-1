...
| General tier | 20,977 (open — all new entries here) |
| Next entry ID | 23962 |
| Candidate words | 2,595 |
...
- Range = ID rounded down to nearest 500 (e.g., 23962 → `entries/23500/`)
...
- **General** (20,977+): All other vocabulary. All new entries go here.
