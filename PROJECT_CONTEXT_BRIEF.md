...
| Metric | Value |
|--------|-------|
| Total entries | 25,978 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,195 (open — all new entries here) |
| Next entry ID | 26186 |
| Candidate words | 1,594 |
| Cross-references | ~12,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 26186 → `entries/26000/`)
...
- **General** (23,195+): All other vocabulary. All new entries go here.
