...
| Metric | Value |
|--------|-------|
| Total entries | 24,408 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,625 (open — all new entries here) |
| Next entry ID | 24611 |
| Candidate words | 1,942 |
| Cross-references | ~8,600 |
| Example sentences | ~98,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 24611 → `entries/24500/`)
...
- **General** (21,625+): All other vocabulary. All new entries go here.
