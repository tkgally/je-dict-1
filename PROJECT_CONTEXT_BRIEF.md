...
| Metric | Value |
|--------|-------|
| Total entries | 23,293 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,510 (open — all new entries here) |
| Next entry ID | 23495 |
| Candidate words | 2,993 |
| Cross-references | ~6,300 |
| Example sentences | ~94,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 23495 → `entries/23000/`)
...
- **General** (20,510+): All other vocabulary. All new entries go here.
