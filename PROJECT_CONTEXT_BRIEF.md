...
| Metric | Value |
|--------|-------|
| Total entries | 25,797 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,014 (open — all new entries here) |
| Next entry ID | 26005 |
| Candidate words | 1,783 |
| Cross-references | ~11,600 |
| Example sentences | ~103,400 |
...
- Range = ID rounded down to nearest 500 (e.g., 26005 → `entries/26000/`)
...
- **General** (23,014+): All other vocabulary. All new entries go here.
