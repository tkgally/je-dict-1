...
| Metric | Value |
|--------|-------|
| Total entries | 28,487 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,704 (open — all new entries here) |
| Next entry ID | 28697 |
| Candidate words | 1,568 |
...
- Range = ID rounded down to nearest 500 (e.g., 28697 → `entries/28500/`)
...
- **General** (25,704+): All other vocabulary. All new entries go here.
