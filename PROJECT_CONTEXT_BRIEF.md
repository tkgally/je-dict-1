...
| Metric | Value |
|--------|-------|
| Total entries | 26,222 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,439 (open — all new entries here) |
| Next entry ID | 26430 |
| Candidate words | 1,347 |
...
- Range = ID rounded down to nearest 500 (e.g., 26430 → `entries/26000/`)
...
- **General** (23,439+): All other vocabulary. All new entries go here.
