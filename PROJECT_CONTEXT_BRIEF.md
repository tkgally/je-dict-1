...
| Metric | Value |
|--------|-------|
| Total entries | 28,257 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,474 (open — all new entries here) |
| Next entry ID | 28466 |
| Candidate words | 1,536 |
| Cross-references | ~16,200 |
| Example sentences | ~111,600 |
...
- Range = ID rounded down to nearest 500 (e.g., 28466 → `entries/28000/`)
...
- **General** (25,474+): All other vocabulary. All new entries go here.
