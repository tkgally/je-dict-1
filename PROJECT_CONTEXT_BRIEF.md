...
| Metric | Value |
|--------|-------|
| Total entries | 29,537 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,734 (open — all new entries here) |
| Next entry ID | 29747 |
...
- Range = ID rounded down to nearest 500 (e.g., 29747 → `entries/29500/`)
...
- **General** (26,734+): All other vocabulary. All new entries go here.
