...
| Metric | Value |
|--------|-------|
| Total entries | 28,057 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,274 (open — all new entries here) |
| Next entry ID | 28266 |
| Candidate words | 1,647 |
| Cross-references | ~16,100 |
| Example sentences | ~110,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 28266 → `entries/28000/`)
...
- **General** (25,274+): All other vocabulary. All new entries go here.
