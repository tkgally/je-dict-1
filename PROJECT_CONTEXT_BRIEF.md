...
| Metric | Value |
|--------|-------|
| Total entries | 24,488 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,705 (open — all new entries here) |
| Next entry ID | 24691 |
| Candidate words | 1,866 |
| Cross-references | ~8,800 |
| Example sentences | ~98,800 |
...
- Range = ID rounded down to nearest 500 (e.g., 24691 → `entries/24500/`)
...
- **General** (21,705+): All other vocabulary. All new entries go here.
