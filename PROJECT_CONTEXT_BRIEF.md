...
| Metric | Value |
|--------|-------|
| Total entries | 29,819 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,016 (open — all new entries here) |
| Next entry ID | 30029 |
| Candidate words | 1,092 |
| Cross-references | ~16,500 |
| Example sentences | ~116,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 30029 → `entries/30000/`)
...
- **General** (27,016+): All other vocabulary. All new entries go here.
