...
| Metric | Value |
|--------|-------|
| Total entries | 24,933 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 22,150 (open — all new entries here) |
| Next entry ID | 25136 |
| Candidate words | 1,406 |
| Cross-references | ~9,800 |
| Example sentences | ~100,300 |
...
- Range = ID rounded down to nearest 500 (e.g., 25136 → `entries/25000/`)
...
- **General** (22,150+): All other vocabulary. All new entries go here.
