...
| Metric | Value |
|--------|-------|
| Total entries | 25,963 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,180 (open — all new entries here) |
| Next entry ID | 26171 |
| Candidate words | 1,612 |
| Cross-references | ~12,000 |
| Example sentences | ~103,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 26171 → `entries/26000/`)
...
- **General** (23,180+): All other vocabulary. All new entries go here.
