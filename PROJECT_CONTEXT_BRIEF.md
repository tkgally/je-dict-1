...
| Metric | Value |
|--------|-------|
| Total entries | 28,122 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,339 (open — all new entries here) |
| Next entry ID | 28331 |
...
- Range = ID rounded down to nearest 500 (e.g., 28331 → `entries/28000/`)
...
- **General** (25,339+): All other vocabulary. All new entries go here.
