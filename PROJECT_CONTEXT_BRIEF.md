...
| Metric | Value |
|--------|-------|
| Total entries | 29,935 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,132 (open — all new entries here) |
| Next entry ID | 30145 |
| Candidate words | 1,040 |
...
- Range = ID rounded down to nearest 500 (e.g., 30145 → `entries/30000/`)
...
- **General** (27,132+): All other vocabulary. All new entries go here.
