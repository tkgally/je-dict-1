...
| Metric | Value |
|--------|-------|
| Total entries | 30,031 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,228 (open — all new entries here) |
| Next entry ID | 30241 |
| Candidate words | 1,014 |
...
- Range = ID rounded down to nearest 500 (e.g., 30241 → `entries/30000/`)
...
- **General** (27,228+): All other vocabulary. All new entries go here.
