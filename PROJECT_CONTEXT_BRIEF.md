...
| Metric | Value |
|--------|-------|
| Total entries | 28,833 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,050 (open — all new entries here) |
| Next entry ID | 29043 |
| Candidate words | 1,475 |
| Cross-references | ~16,300 |
| Example sentences | ~113,500 |
...
- Range = ID rounded down to nearest 500 (e.g., 29043 → `entries/29000/`)
...
- **General** (26,050+): All other vocabulary. All new entries go here.
