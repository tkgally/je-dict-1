...
| Metric | Value |
|--------|-------|
| Total entries | 28,146 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 25,363 (open — all new entries here) |
| Next entry ID | 28355 |
| Candidate words | 1,581 |
| Cross-references | ~16,100 |
| Example sentences | ~111,200 |
...
- Range = ID rounded down to nearest 500 (e.g., 28355 → `entries/28000/`)
...
- **General** (25,363+): All other vocabulary. All new entries go here.
