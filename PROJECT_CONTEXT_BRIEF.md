...
| Metric | Value |
|--------|-------|
| Total entries | 23,451 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 20,668 (open — all new entries here) |
| Next entry ID | 23653 |
| Candidate words | 2,905 |
| Cross-references | ~6,600 |
| Example sentences | ~95,100 |
...
- Range = ID rounded down to nearest 500 (e.g., 23653 → `entries/23500/`)
...
- **General** (20,668+): All other vocabulary. All new entries go here.
