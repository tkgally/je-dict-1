...
| Metric | Value |
|--------|-------|
| Total entries | 23,825 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 21,042 (open — all new entries here) |
| Next entry ID | 24027 |
| Candidate words | 2,528 |
...
- Range = ID rounded down to nearest 500 (e.g., 24027 → `entries/24000/`)
...
- **General** (21,042+): All other vocabulary. All new entries go here.
