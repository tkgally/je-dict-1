...
| Metric | Value |
|--------|-------|
| Total entries | 27,698 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 24,915 (open — all new entries here) |
| Next entry ID | 27907 |
...
- Range = ID rounded down to nearest 500 (e.g., 27907 → `entries/27500/`)
...
- **General** (24,915+): All other vocabulary. All new entries go here.
