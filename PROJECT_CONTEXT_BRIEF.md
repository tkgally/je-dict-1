...
| Metric | Value |
|--------|-------|
| Total entries | 26,190 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 23,407 (open — all new entries here) |
| Next entry ID | 26398 |
| Candidate words | 1,380 |
| Cross-references | ~12,900 |
| Example sentences | ~104,700 |
...
- Range = ID rounded down to nearest 500 (e.g., 26398 → `entries/26000/`)
...
- **General** (23,407+): All other vocabulary. All new entries go here.
