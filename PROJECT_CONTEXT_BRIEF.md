...
| Metric | Value |
|--------|-------|
| Total entries | 30,224 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 27,421 (open — all new entries here) |
| Next entry ID | 30434 |
| Candidate words | 1,004 |
| Cross-references | ~17,600 |
| Example sentences | ~117,900 |
...
- Range = ID rounded down to nearest 500 (e.g., 30434 → `entries/30000/`)
...
- **General** (27,421+): All other vocabulary. All new entries go here.
