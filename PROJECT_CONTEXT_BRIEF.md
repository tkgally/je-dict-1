...
| Metric | Value |
|--------|-------|
| Total entries | 29,594 |
| Basic tier | 801 (closed) |
| Core tier | 1,982 (closed) |
| General tier | 26,791 (open — all new entries here) |
| Next entry ID | 29804 |
| Candidate words | 1,148 |
...
- Range = ID rounded down to nearest 500 (e.g., 29804 → `entries/29500/`)
...
- **General** (26,791+): All other vocabulary. All new entries go here.
