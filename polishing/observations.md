...
## 2026-06-11 — Routine v2 polish session (entries 06048–06067)

- [pattern] Systematic semantic tag errors in the 06048–06067 range: compound verbs and suru verbs were assigned object-category semantic tags (electronics, clothing, tool, furniture, animal-mammal, occupation, body-part) instead of action/cognition/communication/emotion tags. Fixed in this session: 06051 clothing→movement, 06052 [food,leisure,tool]→action, 06053 [communication,furniture]→cognition, 06055 electronics→emotion, 06056 electronics→communication, 06058 animal-mammal→communication, 06060 electronics→cognition, 06062 occupation→cognition, 06066 action→emotion, 06067 action→emotion. Root cause: original AI content generation applied topic-domain tags based on context rather than verb semantics. The 06000 range likely has further instances; the `check_tag_drift.py` detector (P20) should catch remaining cases.
- [pattern] Many inline links in the 06000 range were missing entirely before this session — no ⟦⟧ markup in examples or notes. This appears to be a batch of entries that were created before inline-link polishing was standard practice.
