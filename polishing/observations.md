...
## 2026-05-12 — comprehensive polish session 010 (entries 00800–00825)
- [pattern] Entry 00814_sugu had a full godan-gu verb conjugation table and verb_class tag despite being an adverb. The conjugated forms were nonsensical (すがない, すいだ, etc.). Fixed by removing the conjugation block and verb_class tag. Worth running a scan to check other adverb entries for similar misapplied conjugation tables.
