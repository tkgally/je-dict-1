...
## 2026-05-16 — comprehensive polish session 004 (entries 01673–01692)
- [pattern] Entries 01679 (あいにく, adverb) and 01680 (遠く, noun/adverb) both had full godan conjugation tables with `verb_class: godan-ku` tags — structurally incorrect for non-verb entries. The add_conjugations.py script appears to have matched on the く ending rather than the POS field. Both tables were removed. Sessions in the 01600s–01700s range should watch for this same pattern in other く-ending adverbs/nouns.
